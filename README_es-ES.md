...
### Conducción del Tesla Cybertruck de Madera

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt de video detallado que muestra un Tesla Cybertruck con acabado de laca de madera de avellana conduciendo por un río rocoso.

#### 📝 Prompt

```
Un Tesla Cybertruck subiendo por un río extremadamente rocoso, caracterizado por un envoltorio de vinilo color avellana con un acabado realista de laca de madera, detalles en latón alrededor de los neumáticos, a lo largo de la parte inferior del vehículo y enmarcando el parachoques delantero
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2103381999214026752/img/LpSKI9EiI3YZGBN5.jpg" width="600" alt="Conducción del Tesla Cybertruck de Madera">
...
```
una mujer con rasgos de rata, de ojos grandes, mirando de reojo a la cámara y orientada perpendicularmente hacia la derecha, sonriendo...
...
> Prompt de mensaje social para Grok Imagine que insta a alzarse contra la trata de personas y bendecir a Estados Unidos.

#### 📝 Prompt

```
@Image1 Todos debemos alzar la voz contra la trata de personas. Dios bendiga a Estados Unidos. Manténganse a salvo.
```
...
---
### Transformación al estilo proxeneta clásico

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt que instruye al modelo para transformar la expresión y los gestos de una persona, haciéndola actuar como un proxeneta clásico exigiendo dinero.

#### 📝 Prompt

```
Transforma al hombre de la foto para que actúe como un proxeneta clásico exigiendo su dinero. Dale una expresión severa, seria y sin rodeos, con los ojos entrecerrados y una sonrisa de confianza. Cambia sus gestos de manos a una pose exigente: una mano extendida pa...
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2103237544418725888/img/NcCEjj9qe5-YlE41.jpg" width="600" alt="Transformación al estilo proxeneta clásico">
...
> Un prompt de video complejo que involucra la consistencia del personaje a partir de imágenes de referencia y un entorno lujoso.

#### 📝 Prompt

```
Escena cinematográfica del hombre elegante de cabello largo, con gafas de sol, tatuajes y ropa oscura de @Image1 y @Image2. Está sentado casualmente en una barra de bar tenuemente iluminada, luciendo misterioso, luego se levanta y camina con confianza por un pasillo dorado y ornamentado de lujo...
```
...
---
### Animación sutil de barra

![English](https://img.shields.io/badge/lang-English-blue)

> Prompt de video para una animación sutil de un hombre apoyado en una barra, enfocándose en la respiración y el movimiento de la cabeza.

#### 📝 Prompt

```
Animación cinematográfica sutil del hombre con cabello oscuro largo y ondulado y gafas de sol rectangulares apoyado en la barra de madera. Gira lentamente la cabeza hacia la cámara con una expresión fría e intensa, respiración y movimiento de hombros sutiles, cambio de enfoque suave...
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2103226062792757248/img/Q_68HyhlZM8HFWFi.jpg" width="600" alt="Animación sutil de barra">
...
Un apuesto y musculoso viajero fantástico de cabello plateado camina lentamente más adentro por los impresionantes cañones de roca roja de Bryce Canyon, Utah. Imponentes paredes de arenisca naranja y carmesí y extrañas formaciones hoodoo se alzan majestuosamente...
```
...
<sub>🤖 This README is automatically generated. Last updated: 2026-09-26T04:45:32.026Z</sub>
