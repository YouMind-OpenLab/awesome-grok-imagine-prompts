...
> Un prompt para generar un video de un rascacielos superalto en Manhattan, esculpido arquitectónicamente mediante procesos de sustracción computacional para crear grandes cavidades.

#### 📝 Prompt

```
Torre superalta generada por IA en Manhattan, estructura vertical de 430 m esculpida mediante un proceso de sustracción computacional, con enormes cavidades talladas
```
...
> Un prompt base para grok-imagine diseñado para crear videos en primera persona, de estilo realista y cámara en mano, que simulan metraje encontrado grabado con un iPhone.

#### 📝 Prompt

```
VIDEO DE METRAJE ENCONTRADO ESTILO GUERRILLA, CÁMARA EN MANO. ÁNGULO ESTRECHO Y DE ASPECTO REALISTA. ÉL SOSTIENE LA CÁMARA DEL IPHONE Y ESTÁ COMPLETAMENTE FUERA DEL ENCUADRE, SIN SUPERPOSICIONES GRÁFICAS. VISTA DE CÁMARA EN PRIMERA PERSONA ÚNICAMENTE
```
...
> Un prompt de video al estilo de un libro infantil fantástico que muestra a jóvenes futuros astronautas flotando en gravedad cero en el Space Camp de Huntsville.

#### 📝 Prompt

```
Jóvenes futuros astronautas con chalecos de Space Scout y ropa gris jaspeado oscuro flotando y divirtiéndose en las cámaras de gravedad cero del Space Camp de Huntsville. Estilo de libro electrónico infantil fantástico, alegre y emocionante, con una atmósfera inspiradora.
```
...
> Un complejo prompt de video que describe un calendario mecánico intrincado al estilo de los bocetos de Leonardo da Vinci, con ruedas de bronce entrelazadas y alineación planetaria.

#### 📝 Prompt

```
(Si procede, imagina un boceto al estilo de da Vinci: como los trenes de engranajes de su Codex Atlanticus pero para el tiempo mismo; ruedas de bronce entrelazadas etiquetadas como “360 días Egipto”, “ruta del cometa Venus” y “honda de Marte”, con una inclinación repentina del eje que agrieta el mecanismo; diminutas figuras humanas (faraones, sacerdotes mayas) se apresuran a añadir cinco “días sagrados” mientras un vórtice arremolinado de planetas realinea toda la máquina del calendario en una perspectiva renacentista perfecta).
```
...
```
Un gnomo de jardín macho extiende la mano y toca la mano de una gnomo de jardín hembra, y el cielo estalla en estrellas y la Vía Láctea
```
...
> Un prompt para una ilustración digital futurista que representa el vínculo entre madre e hija con un estilo de ciencia ficción.
...
<sub>🤖 This README is automatically generated. Last updated: 2026-05-28T22:10:50.572Z</sub>
