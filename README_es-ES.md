...
> Un prompt narrativo que describe a una mujer contestando una llamada telefónica seguida de un golpe en la puerta.

#### 📝 Prompt

```
Suena el teléfono. Ella lo contesta. ¡Hola, cariño! Luego, un golpe en la puerta. Ella abre...
```
...
> Un prompt detallado para la generación de video que utiliza una imagen de referencia de un personaje arquero para generar una secuencia de acción específica.

#### 📝 Prompt

```
[Objetivo de Generación]
Generar un video del personaje musculoso de la imagen de referencia realizando una acción natural de "defecar" mientras permanece fiel a su carácter.
...
> Un prompt de generación de video para Grok Imagine que describe un monolito rompiéndose con un rayo de luz disparando hacia el cielo.

#### 📝 Prompt

```
El monolito se rompe y emerge un rayo de luz que dispara directamente hacia el cielo
```
...
> Un prompt con texto en croata ('Las imágenes se apilan, se convierten en un espejo y desaparecen con un golpe de trueno') para generar un corto video vertical basado en las imágenes proporcionadas.
...
---
### Hacienda puritana del siglo XVII

![English](https://img.shields.io/badge/lang-English-blue)

> Prompt para generar una escena de video de una hacienda puritana del siglo XVII, al estilo de Robert Eggers, con chimenea.

#### 📝 Prompt

```
Comencemos con una pequeña casa de hacienda puritana del siglo XVII, con chimenea, al estilo de la película 'La Bruja' de Robert Eggers
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2102807839550976000/img/pD-9w9SYYEmG9YFV.jpg" width="600" alt="Hacienda puritana del siglo XVII">
...
> Un prompt detallado para Grok Imagine que genera una pintura al óleo de estilo renacentista-barroco de una estatua del Arcángel Miguel en un entorno museístico, combinando los estilos de Miguel Ángel y Bernini.

#### 📝 Prompt

```
Una magistral pintura al óleo de estilo renacentista-barroco que representa una estatua de mármol crema del Arcángel Miguel como ángel guerrero, fusión de los estilos de Miguel Ángel y Bernini. Rostro idealizado al modo de Miguel Ángel, con mirada noble y severa, y cabello ondulado tallado. Movimiento dramático al estilo de Bernini, con grandes alas escultóricas completamente extendidas y drapeados tallados fluidos en pliegues pesados. Mármol crema envejecido con pinceladas de sombra marrón cálido en los pliegues. Una coraza metálica plateada-azulada brillante sobre el pecho que resplandece con una luz fría azuleante. El brazo derecho de la estatua está completamente esculpido y extendido hacia afuera en un gesto noble de guerrero con la mano abierta; el brazo izquierdo cuelga a lo largo del cuerpo. Estatua de escala museística sobre un pedestal ornamental de piedra tallada, punto focal claro de la sala.
Alrededor del pedestal se encuentran cuatro columnas bajas de mármol crema elaboradamente talladas, conectadas por una cadena metálica simple y elegante, actuando como barrera interior del museo. Galería de un gran palacio italiano o cámara de maravillas similar a las del Vaticano. Paredes densamente cubiertas con pinturas al óleo de los siglos XVI y XVII en marcos dorados pesados. Un escritorio antiguo de madera tallada en primer plano con papeles, pluma, tintero y una vela encendida. Colecciones circundantes: globos terráqueos, libros encuadernados en cuero, bustos pequeños de mármol, gabinetes de madera con artefactos, todos secundarios y ligeramente más oscuros para que la estatua domine la atención.
Luz cálida de araña dorada y velas, rico claroscuro caravagiano, sombras teñidas de violeta en las esquinas. Suelo de mármol pulido con reflejos, techo artesonado dorado. Aspecto cinematográfico de pintura antigua al óleo. Texturas altamente detalladas de mármol, armadura metálica, cadena, marcos de pan de oro y lienzo envejecido. Sin objetos modernos. Sin vallas de hierro. Sin extremidades faltantes.
```
...
<sub>🤖 This README is automatically generated. Last updated: 2026-09-24T13:42:17.606Z</sub>
