...
```
Usa mi imagen como base para una atractiva mujer rubia de unos 20 y tantos años, vistiendo ropa vaquera de alta gama, guiando a un caballo appaloosa (con silla de montar vaquera) a través de un huerto de manzanas al atardecer. Ella se detiene, toma una manzana y se la da al caballo. Observa felizmente cómo su caballo se come la manzana entera.
```
...
---
### Transformación de papel de cocina en alienígena

![English](https://img.shields.io/badge/lang-English-blue)

> Un video de transformación creativa donde un papel de cocina se convierte en un alienígena que entra en una nave espacial y vuela hacia las nubes.

#### 📝 Prompt

```
Haz que este papel de cocina se convierta en un alienígena, súbelo a su nave y despega hacia las nubes
```

<img src="https://customer-qs6wnyfuv0gcybzj.cloudflarestream.com/8677e46426086f53df1a9e281b17aa49/thumbnails/thumbnail.jpg" width="600" alt="Transformación de papel de cocina en alienígena">
...
> Un prompt de video cinemático de una mujer y su robot acompañante dentro de una SpaceX Starship con vista al espacio.

#### 📝 Prompt

```
Una mujer de cabello claro que viste un elegante atuendo negro futurista, acompañada por un pequeño robot, de pie dentro de la sección de pasajeros de un cohete SpaceX Starship diseñado para pasajeros. El interior cuenta con una gran área de visualización transparente que revela estrellas y nubes cósmicas en el espacio.
```
...
---
### Desaparición de alas de código resplandeciente
...
```
Sus alas desaparecen en un código resplandeciente, ella dice: «si haces esto, nada volverá a ser igual. No más noches tranquilas a solas, pondrán tu vida patas arriba buscando cualquier cosa que puedan usar en tu contra...»
```

<img src="https://customer-qs6wnyfuv0gcybzj.cloudflarestream.com/19f6b62ab029c260c79a14ac8da1dda7/thumbnails/thumbnail.jpg" width="600" alt="Desaparición de alas de código resplandeciente">
...
---
### Video de sendero forestal de fantasía steampunk

![English](https://img.shields.io/badge/lang-English-blue)

> Un mágico prompt de video steampunk que presenta a un mago y una reina de las hadas caminando por un bosque hacia una biblioteca.

#### 📝 Prompt

```
Ambiente mágico steampunk
Un mago y una reina de las hadas caminan por un sendero forestal hacia una cabaña y entran en una biblioteca
```

<img src="https://customer-qs6wnyfuv0gcybzj.cloudflarestream.com/9f7fcc8c1a4d4a3ca5efdfd5e106aeb3/thumbnails/thumbnail.jpg" width="600" alt="Video de sendero forestal de fantasía steampunk">
...
---
### Animación de un Sentinel de Matrix estilo chibi

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt de video creativo que genera un Sentinel de Matrix estilo chibi realizando el gesto de un emoji de cara palmada (face-palm) con un efecto de alejamiento.

#### 📝 Prompt

```
Ahora haz un zoom out hacia un sentinel de la película “Matrix” pero en estilo chibi haciendo el gesto de un emoji de golpearse la cara
```

<img src="https://cms-assets.youmind.com/media/1780043959273_tjmkzf_HJbP2mJWIAM1_uu.jpg" width="600" alt="Animación de un Sentinel de Matrix estilo chibi">
...
> Un prompt de video detallado que presenta a una linda chica estilo chibi surfeando hábilmente sobre olas de color azul brillante y verde bajo un cielo soleado.

#### 📝 Prompt

```
Una linda chica chibi surfeando en un hermoso océano con vibrantes olas azules y verdes bajo un cielo soleado. Lleva un elegante traje de surf negro y mantiene el equilibrio con destreza…..
```
...
---
### Plataforma de perforación en alta mar abandonada

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt de video cinematográfico detallado de 10 segundos sobre una ruina industrial postapocalíptica y neblinosa en el océano, con iluminación inquietante y un seguimiento lento.

#### 📝 Prompt

```
Una enorme plataforma de perforación en alta mar abandonada se encuentra medio colapsada en un océano tormentoso y cubierto de niebla al amanecer. La cámara se desliza baja y lenta justo por encima del agua negra, moviéndose a través de una espesa bruma mientras vigas de acero oxidadas, cables colgantes y focos rotos se alzan sobre ella. La plataforma cruje débilmente, con el metal gimiendo bajo la presión del viento. El agua de mar salpica contra los soportes corroídos y los escombros a la deriva chocan suavemente contra la estructura. La cámara avanza hacia el interior sombrío de la plataforma, donde la maquinaria industrial yace inactiva e inundada, cubierta de sal y decadencia. A medida que la cámara se acerca a la ventana de una sala de control agrietada por manchas de sal, un monitor de advertencia parpadea débilmente, mostrando estática distorsionada. De repente, una baliza de emergencia roja en lo profundo de la estructura cobra vida, proyectando un brillo tenue y pulsante a través de la bruma. La escena se mantiene en suspenso, combinando el realismo postapocalíptico con una inquietante presencia industrial.
Estilo de escena: niebla oceánica postapocalíptica | ruina industrial | seguimiento en ángulo bajo | suspenso cinematográfico | diseño de sonido ambiental | decadencia ultrarrealista | deslizamiento lento de cámara | difusión dramática de niebla
Duración: 10 segundos
Relación de aspecto: 16:9
Movimiento: toma de seguimiento suave, balanceo sutil como de dron estabilizado en mano
...
<img src="https://customer-qs6wnyfuv0gcybzj.cloudflarestream.com/b11868815b31bb8f7e83b37b89d6cf64/thumbnails/thumbnail.jpg" width="600" alt="Plataforma de perforación en alta mar abandonada">
...
```
Convierte esta imagen en un caracol en movimiento con efectos brillantes y hongos como ojos. Haz que se mueva más lento, como un caracol de verdad...
```
...
> Un divertido prompt de video cinematográfico que representa una variante de la historia del Jardín del Edén protagonizada por dos hombres.

#### 📝 Prompt

```
Dos hombres en el Jardín del Edén en lugar de Adán y Eva; simplemente son Adán y Steve, quienes se miran el uno al otro y uno le dice al otro: ¡este no fue un buen plan de negocios!
```
...
---
### Video de luces flotantes y resplandor de farolillos

![English](https://img.shields.io/badge/lang-English-blue)

> Un prompt de video tranquilo que crea una escena de luces y farolillos flotando sobre aguas serenas, enfatizando la paz y el resplandor.

#### 📝 Prompt

```
Perdido en un mundo de luces flotantes y aguas tranquilas. Nada más que paz y el resplandor de los farolillos esta noche.
```

<img src="https://customer-qs6wnyfuv0gcybzj.cloudflarestream.com/b46948071549d36f22b079c4df00722c/thumbnails/thumbnail.jpg" width="600" alt="Video de luces flotantes y resplandor de farolillos">
...
<sub>🤖 This README is automatically generated. Last updated: 2026-05-30T04:14:26.195Z</sub>
