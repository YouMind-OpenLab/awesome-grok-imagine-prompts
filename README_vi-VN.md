...
### Cảnh nấu bữa tối với các nhân vật

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh tạo video mô tả hai nhân vật, Alice và Dani, đang chuẩn bị bữa tối trong không gian bếp và sử dụng các tham chiếu nhân vật.

#### 📝 Prompt

```
Alice @Reference3 và Dani @Reference2 đang thái rau củ trên bàn bếp và bắt đầu chuẩn bị bữa tối với tư cách là Elara
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2096824592191156224/img/NjV-g4oS7Kv66QV2.jpg" width="600" alt="Cảnh nấu bữa tối với các nhân vật">
...
---
### Hình ảnh tháp băng giá đậm chất điện ảnh

![English](https://img.shields.io/badge/lang-English-blue)

> Lời nhắc (prompt) điện ảnh đa tầng chi tiết mô tả góc quay từ trên cao về một nhân vật giống phi hành gia đang ngồi trên tháp phát thanh đóng băng phía trên cảnh quan thành phố mùa đông.

#### 📝 Prompt

```
Góc quay rộng đậm chất điện ảnh về một nhân vật mặc bộ đồ bay màu kem và đội mũ bảo hiểm có kính che tối màu, đang ngồi trên mép một tháp phát thanh gỉ sét phủ đầy băng giá ở vị trí cao phía trên thành phố phủ tuyết, cơ thể bất động và thẳng đứng, đôi tay đeo găng đặt trên thanh dầm, những tảng băng lớn treo lơ lửng từ khung kim loại, con sông đóng băng uốn lượn qua những mái nhà trắng xóa phía xa bên dưới, bầu trời mùa đông xanh trong, ánh nắng lạnh lẽo chiếu trên thép và sương giá, không khí chân thực như ảnh chụp, cảm giác về độ cao cực lớn, kết cấu vải, kim loại và băng siêu chi tiết, Grok Imagine.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2096471558961471488/img/jMxNQMBfaKgIgM3k.jpg" width="600" alt="Hình ảnh tháp băng giá đậm chất điện ảnh">
...
---
### Chuyển động úp rổ bóng rổ

![English](https://img.shields.io/badge/lang-English-blue)

> Tạo video một nhân vật đang dẫn bóng và thực hiện cú úp rổ theo phong cách Michael Jordan.

#### 📝 Prompt

```
Hãy để cô ấy dẫn bóng về phía rổ và thực hiện cú úp rổ kiểu Michael Jordan vào vành rổ
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2096773020664676354/img/NPyEHr-UVx-AvAGz.jpg" width="600" alt="Chuyển động úp rổ bóng rổ">
...
---
### Hoạt ảnh Điêu khắc Thể hình

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh tạo hoạt ảnh độc đáo giúp biến bức tượng đá cẩm thạch thành một vận động viên thể hình với mái tóc bồng bềnh.

#### 📝 Prompt

```
Hãy tạo hoạt ảnh cho bức tượng này. Làm cho nó trông như đang tham gia một cuộc thi thể hình nhưng vẫn giữ nguyên phong cách đá cẩm thạch tuyệt đẹp và làm cho mái tóc trông như đang bay bổng trong không trung.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2096746420946808832/img/Zwxsao94TVbGmDvZ.jpg" width="600" alt="Hoạt ảnh Điêu khắc Thể hình">
...
---
### Hoạt ảnh Hồ sơ Dọc Kỹ thuật

![日本語](https://img.shields.io/badge/lang-日本語-green)

> Một câu lệnh kỹ thuật chi tiết để duy trì bố cục UI và nhân vật nhất quán, sử dụng hai hình ảnh tham chiếu cho video dọc dài 15 giây.

#### 📝 Prompt

```
15 giây, dọc 9:16. Sử dụng hai hình ảnh được cung cấp làm tham chiếu.

- Sử dụng ảnh chụp màn hình hồ sơ X làm tham chiếu duy nhất cho nền, UI và bố cục.
- Sử dụng hình ảnh phóng to của MoiMoi làm tham chiếu duy nhất cho thiết kế nhân vật.

Duy trì hình ảnh tiêu đề của ảnh gốc, nền UI màu đen, vị trí biểu tượng hồ sơ, từng nút bấm, biểu tượng đồ họa, đường phân cách, hình ảnh đã đăng, bố cục màn hình, lề, màu sắc và tỷ lệ.

Camera hoàn toàn cố định. Không thu phóng, lia máy, xoay, nghiêng, cắt hoặc tái tạo màn hình. Không kéo giãn hình ảnh gốc. Để vừa với tỷ lệ 9:16, không thêm thanh màu đen; hãy mở rộng các cạnh của UI một cách tự nhiên hoặc điều chỉnh vị trí tinh tế để lấp đầy toàn bộ màn hình.

Mục đích hoạt ảnh:
Miêu tả nhân vật chuyển động sống động trong khu vực hình ảnh đã đăng của màn hình hồ sơ tĩnh.

Chuyển động của nhân vật:
- MoiMoi không rời khỏi khung hình của ảnh đã đăng.
- Vẫy tay đầy năng lượng về phía camera.
- Chớp mắt và cử động miệng như đang nói (không cần âm thanh).
- Tóc và quần áo đung đưa trong làn gió nhẹ.
- Lan tỏa sự quyến rũ tại chỗ mà không thay đổi tư thế đáng kể.

Cố định nền:
- Không di chuyển bất kỳ thành phần UI nào ngoài hình ảnh đã đăng (biểu tượng, văn bản, nút bấm, v.v.).
- Đảm bảo màu sắc UI không thay đổi và không xuất hiện nhiễu.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2096736177114214400/img/JfLqTgNAfxYAoLE5.jpg" width="600" alt="Hoạt ảnh Hồ sơ Dọc Kỹ thuật">
...
---
### Những con đường ánh sao nơi biên giới

![English](https://img.shields.io/badge/lang-English-blue)

> Một lời nhắc video khoa học viễn tưởng đầy chất thơ, hình ảnh hóa các tên lửa, robot và mạch điện trông giống như những con đường ánh sao giữa hư không.

#### 📝 Prompt

```
Biên giới, một đoạn mã được kết nối vào hư không, trông nó như thế nào nhỉ, những tên lửa, robot, mạch điện tựa như những con đường ánh sao
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2096724507147063296/img/d2g4xcUIEhni8dtG.jpg" width="600" alt="Những con đường ánh sao nơi biên giới">
...
---
### Hoạt hình trận chiến siêu anh hùng hoành tráng

![English](https://img.shields.io/badge/lang-English-blue)

> Một gợi ý tạo hoạt hình năng động cho trận chiến giữa một siêu anh hùng tôn giáo với bộ giáp thánh và một thủ lĩnh quỷ dữ khổng lồ từ địa ngục.

#### 📝 Prompt

```
Hoạt hình trận chiến năng động hoành tráng: siêu anh hùng tôn giáo với bộ giáp thánh rực rỡ và đôi cánh ánh sáng đang giao tranh quyết liệt với thủ lĩnh quỷ dữ khổng lồ từ địa ngục.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2096709743024685058/img/6kh_HaXAFJgRehM7.jpg" width="600" alt="Hoạt hình trận chiến siêu anh hùng hoành tráng">
...
---
### Video chú mèo dễ thương trong ly kem sundae

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh mô tả, chân thực về chú mèo trắng ngồi trong ly kem sundae khổng lồ đang tan chảy trên con phố đầy nắng.

#### 📝 Prompt

```
Cú máy trung cảnh điện ảnh đầy ngẫu hứng về một chú mèo trắng lông xù đeo kính râm tròn, đang ngồi đầy kiêu hãnh bên trong một ly kem sundae khổng lồ đang tan chảy, những vòng kem vani mềm mịn cao vút đang đổ sụp, sốt sô-cô-la bóng bẩy cùng sốt dâu tây tươi rói chảy tràn xuống các cạnh, một quả anh đào đỏ thắm cân bằng trên đỉnh, phía sau là con phố đầy nắng với những mặt tiền cửa hàng rực rỡ sắc màu và hiệu ứng bokeh ánh sáng ban ngày ấm áp, phong cách siêu thực dễ thương chân thực, kết cấu ngọt ngào dính dấp, biểu cảm tự tin tinh nghịch, bộ lông và bề mặt món tráng miệng chi tiết đến kinh ngạc, ánh sáng tươi sáng vui vẻ, và Grok Imagine.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2096471204890898432/img/fOtYCQxm1EPiYcbR.jpg" width="600" alt="Video chú mèo dễ thương trong ly kem sundae">
...
---
### Video tàu vũ trụ pha lê đậm chất điện ảnh

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh chi tiết để tạo video về các con tàu ánh sáng pha lê của người Pleiades với hiệu ứng ánh sáng thể tích.

#### 📝 Prompt

```
Người Pleiades trên tàu mẹ ánh sáng, phi thuyền pha lê hình đĩa, kiệt tác, chất lượng siêu nét 1111111111111111111111111111999999999999999999999999 k , ánh sáng thể tích rực rỡ cùng các tông màu và đổ bóng
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2096675326483156992/img/DRG5Zy58QnxgMKZb.jpg" width="600" alt="Video tàu vũ trụ pha lê đậm chất điện ảnh">
...
> Một gợi ý chuyển động camera điện ảnh di chuyển dọc theo các bức tường lâu đài nhìn xuống thành phố phong cách steampunk vào ban đêm.

#### 📝 Prompt

```
Di chuyển dọc theo các bức tường lâu đài trong khi nhìn xuống thành phố phong cách steampunk vào ban đêm.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2096109430022791168/img/8my2JB6LqsIynvmf.jpg" width="600" alt="Chuyển động tường thành phố Steampunk">
...
---
### Lễ phong tước phong cách phim hành động

![日本語](https://img.shields.io/badge/lang-日本語-green)

> Một câu lệnh (prompt) điện ảnh chi tiết về buổi lễ phong tước hiệp sĩ trong phòng ngai vàng hoàng gia với nữ anh hùng và bầu không khí hùng vĩ.

#### 📝 Prompt

```
Một cảnh quay theo phong cách phim hành động, nơi một nữ anh hùng xinh đẹp diện kiến nữ hoàng trong phòng ngai vàng của lâu đài hoàng gia, và buổi lễ phong tước hiệp sĩ đang diễn ra. Bầu không khí trang nghiêm và đầy kịch tính, nội thất hoàng gia sang trọng cùng những gam màu quý phái, sống động.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2096091133923450880/img/qlKX5NplHnkbEK2G.jpg" width="600" alt="Lễ phong tước phong cách phim hành động">
...
---
### Infographic về nhịp sinh học và ánh sáng xanh

![English](https://img.shields.io/badge/lang-English-blue)

> Một gợi ý video chi tiết để tạo infographic giải thích cách các tia sáng xanh ảnh hưởng đến quá trình sản xuất melatonin và làm gián đoạn chu kỳ giấc ngủ.

#### 📝 Prompt

```
Infographic về cách các tia sáng xanh ngăn chặn quá trình sản xuất melatonin và làm gián đoạn nhịp sinh học
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2096064200057724929/img/fIEfBLYwO0rd6KX-.jpg" width="600" alt="Infographic về nhịp sinh học và ánh sáng xanh">
...
> Một câu lệnh (prompt) video khoa học viễn tưởng chi tiết cho cảnh quay góc rộng đậm chất điện ảnh về một thành phố hang động ngầm rộng lớn, nổi bật với các mô-đun nhà ở và hiệu ứng ánh sáng ấn tượng.

#### 📝 Prompt

```
Cảnh quay góc rộng đậm chất điện ảnh về một thành phố hang động ngầm rộng lớn với các mô-đun nhà ở màu trắng được xây dựng vào vách đá, những ô cửa sổ tỏa ánh sáng ấm áp, một dòng sông chảy dọc sàn hang, những cây cầu đi bộ mảnh khảnh với những bóng người nhỏ bé đang băng qua, những tia nắng đầy kịch tính đổ xuống từ một lỗ hổng hình tròn trên trần đá, làn sương mờ ảo trong không khí, kiến trúc khoa học viễn tưởng đầy hy vọng, chi tiết chân thực, tĩnh lặng và rạng rỡ
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2095796120920510464/img/ITICRH_Sx2hZd9L-.jpg" width="600" alt="Cảnh quan thành phố hang động ngầm phong cách khoa học viễn tưởng">
...
> Một đoạn prompt video điện ảnh chi tiết về phi hành gia đang lơ lửng trong không gian với các chuyển động camera mượt mà và hậu cảnh đầy sao chân thực.

#### 📝 Prompt

```
Phi hành gia lơ lửng nhẹ nhàng trong môi trường không trọng lực, từ từ xoay người và quan sát xung quanh, những vì sao trôi qua, chuyển động camera tinh tế, chuyển động điện ảnh mượt mà
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2095909220503654401/img/hsDfmA96W5nO1B85.jpg" width="600" alt="Phi hành gia lơ lửng trong môi trường không trọng lực">
...
---
### Streamer người Nhật đang nói chuyện

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh video có độ trung thực cao dành cho các biểu cảm khuôn mặt chân thực và đồng bộ hóa môi.

#### 📝 Prompt

```
Cận cảnh đầu người đang nói chuyện, streamer trẻ người Nhật, chuyển động môi tự nhiên liên tục khớp với lời nói, cách truyền đạt hào hứng đầy căng thẳng, hình dạng miệng thay đổi rõ ràng theo từng âm tiết, chớp mắt và các biểu cảm siêu nhỏ, chân thực như ảnh chụp
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2095868981404135424/img/vMCgSkV-VXeV0IRR.jpg" width="600" alt="Streamer người Nhật đang nói chuyện">
...
> Một câu lệnh điện ảnh dành cho Grok Imagine mô tả cảnh đám đông đang theo dõi một con tàu vũ trụ đế quốc hạ cánh xuống hành tinh của họ.

#### 📝 Prompt

```
Mọi người đang tập trung để theo dõi sự xuất hiện của một con tàu vũ trụ đế quốc tại hành tinh của họ.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2095840557440618496/img/oSgfWL5GnuUmsJ3j.jpg" width="600" alt="Cảnh tàu vũ trụ đế quốc hạ cánh">
...
---
### Phong cảnh Ai Cập thời trẻ của Cleopatra

![English](https://img.shields.io/badge/lang-English-blue)

> Hình ảnh Cleopatra thời trẻ đang nhìn ra vùng đất Ai Cập với cảm nhận về vận mệnh tương lai.

#### 📝 Prompt

```
Cleopatra khi còn trẻ đang nhìn ra Ai Cập với niềm tin rằng một ngày nào đó bà sẽ cai trị nơi này
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2095297599641427968/img/RLicB_jR0nFF0exF.jpg" width="600" alt="Phong cảnh Ai Cập thời trẻ của Cleopatra">
...
---
### Hoạt ảnh đọc sách trong phòng ngủ ấm cúng

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh video Grok Imagine tinh tế hướng dẫn mô hình tạo hoạt ảnh từ hình ảnh tĩnh một người phụ nữ đang bắt cuốn sách rơi, tập trung vào chuyển động chân thực và biểu cảm khuôn mặt phản ứng tự nhiên.

#### 📝 Prompt

```
Tạo một video điện ảnh 15 giây chân thực, ấm cúng từ chính hình ảnh này. Giữ nguyên khuôn mặt, kiểu tóc, áo cardigan, trang sức, tỷ lệ cơ thể, phòng ngủ, giường, sách, đèn, đồ trang trí tường, ánh sáng và bố cục tổng thể của người phụ nữ.

0–4 giây: Cô ấy ngồi thoải mái trên giường, nhìn về phía máy quay với vẻ mặt thư thái, nhẹ nhàng. Cô ấy chớp mắt và hít thở tự nhiên, sau đó liếc nhìn chồng sách bên cạnh.

4–7 giây: Cô ấy với tay về phía chồng sách và nhẹ nhàng rút một cuốn ra. Khi làm vậy, một cuốn sách khác bất ngờ trượt khỏi chồng và rơi xuống sàn.

7–10 giây: Cô ấy phản ứng nhanh, nhoài người về phía trước và vươn tay bắt cuốn sách đang rơi. Cô ấy bắt được nó ngay trước khi nó chạm sàn.

10–12 giây: Cô ấy ngồi thẳng dậy, cầm cuốn sách, nhìn nó với vẻ mặt hơi ngạc nhiên, rồi bật cười nhẹ đầy thích thú.

12–15 giây: Cô ấy nhìn thẳng vào máy quay, mỉm cười tinh nghịch và nói khẽ: “Suýt chút nữa thì xong.” Cô ấy đặt cuốn sách an toàn bên cạnh mình.

Chuyển động của con người tự nhiên, thời gian phản ứng thực tế, cử động tay và ngón tay đáng tin cậy, tương tác chính xác với cuốn sách, tóc chuyển động nhẹ nhàng, chất liệu vải áo cardigan chân thực, biểu cảm khuôn mặt tự nhiên, không khí phòng ngủ buổi chiều ấm cúng, ánh sáng điện ảnh dịu nhẹ, độ sâu trường ảnh nông, cảm giác máy quay cầm tay nhẹ nhàng. Cuốn sách rơi phải di chuyển tự nhiên theo trọng lực và được bắt một cách thực tế. Không diễn xuất cường điệu, không chuyển động máy quay đột ngột, không có người lạ, không thay đổi khuôn mặt, không thay đổi trang phục, không biến dạng bàn tay, không biến đổi vật thể.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2095138179166949376/img/lSmg-daTNlRhHUN2.jpg" width="600" alt="Hoạt ảnh đọc sách trong phòng ngủ ấm cúng">
...
> Một câu lệnh gợi ý mang tính điện ảnh mô tả một chiếc mũ bảo hiểm khổng lồ bị chôn vùi một nửa trên sa mạc với một người đang khám phá bên trong.

#### 📝 Prompt

```
Một chiếc mũ bảo hiểm to bằng ngọn đồi, chìm một nửa dưới sa mạc, và một người đang đứng ở phần kính che mặt mở ra để nhìn vào hệ thống máy móc bên trong.
```

<img src="https://pbs.twimg.com/ext_tw_video_thumb/2094649705397415936/pu/img/8S8DFWA2Byd31neq.jpg" width="600" alt="Khám phá chiếc mũ bảo hiểm khổng lồ trên sa mạc">
...
---
### Trận chiến sử thi giữa Cleopatra và Azael

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh tạo video điện ảnh về cảnh Cleopatra chiến đấu với Azael trong khi khẳng định sự hiện diện của mình.

#### 📝 Prompt

```
Cleopatra, nữ hoàng Ai Cập, vẫn còn sống và hiện diện, tuyên bố 'chính là ta đây Azael, ta vẫn còn sống' trong khi đang chiến đấu với Azael
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094649638238183424/img/V5M5aKB5QtYLnZ0a.jpg" width="600" alt="Trận chiến sử thi giữa Cleopatra và Azael">
...
---
### Hoạt ảnh nhân vật biết nói

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh được thiết kế để tạo hoạt ảnh cho nhân vật với lời thoại cụ thể và tông giọng dễ thương.

#### 📝 Prompt

```
Tạo hoạt ảnh cho hình ảnh này để nói câu “I don’t know which station is Gilmore and which one is Holdom” với một giọng nói dễ thương
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094633812957511680/img/PRBQeuURbuPuz9Dw.jpg" width="600" alt="Hoạt ảnh nhân vật biết nói">
...
---
### Snoop Dogg biến hình thành rồng

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh tạo hoạt ảnh đầy sáng tạo giúp biến Snoop Dogg thành một chú rồng hoạt hình với điếu thuốc đặc trưng.

#### 📝 Prompt

```
Tạo một video về Snoop Dogg biến hình thành một chú rồng hoạt hình với điếu thuốc ngậm ở bên mép miệng
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094628833395691520/img/Qo3rVOgH2zbosWXp.jpg" width="600" alt="Snoop Dogg biến hình thành rồng">
...
---
### Người phụ nữ mỉm cười tại quán cà phê ngoài trời

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh (prompt) điện ảnh chi tiết cho khung cảnh đời thường chân thực về một người phụ nữ đang thư giãn tại quán cà phê ngoài trời với ánh sáng tự nhiên

#### 📝 Prompt

```
Theo phong cách đời thường chân thực, một người phụ nữ đang mỉm cười thư giãn tại quán cà phê ngoài trời, hai tay đặt sau đầu. Cô ấy có mái tóc nâu ngắn, đeo kính râm tối màu, mặc áo sát nách màu đen, đeo dây chuyền mặt vàng nhỏ và vòng tay trên cổ tay, với biểu cảm vui vẻ
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094612892670726144/img/9Di611jujQcOMjtO.jpg" width="600" alt="Người phụ nữ mỉm cười tại quán cà phê ngoài trời">
...
---
### Tiếng ngân nga trong phòng giam đầy cảm xúc

![English](https://img.shields.io/badge/lang-English-blue)

> Một cảnh quay điện ảnh chi tiết về một người phụ nữ đang ngân nga trong phòng giam, được thực hiện bằng kỹ thuật quay cầm tay và tập trung vào các biểu cảm vi mô.

#### 📝 Prompt

```
Cô khẽ ngân nga một bài hát trong phòng giam để xua tan nỗi buồn. Dù đang suy sụp, cô vẫn không từ bỏ hy vọng. Kỹ thuật quay cầm tay cùng những biểu cảm vi mô trên gương mặt cô kể lại câu chuyện về sự trầm cảm bị khuất phục bởi quyết tâm giữ vững niềm tin. Không có lời thoại. Không có âm nhạc nào khác ngoài tiếng ngân nga của cô.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094595558363029504/img/Nvvb-lTqxgxTB3cc.jpg" width="600" alt="Tiếng ngân nga trong phòng giam đầy cảm xúc">
...
---
### Hoạt hình thành phố đóng băng trong ngày tận thế

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh tạo video điện ảnh mô tả một thành phố đang đóng băng theo thời gian thực với những chiếc xe bị đình trệ và tuyết rơi dày đặc.

#### 📝 Prompt

```
6 giây cảnh một thành phố đóng băng theo thời gian thực — xe cộ chết máy giữa đường, tuyết bao phủ kín các con phố.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094592646119628800/img/9iYW8jQRKffSyAU8.jpg" width="600" alt="Hoạt hình thành phố đóng băng trong ngày tận thế">
...
---
### Người phụ nữ huyền bí trong nhà kính phát quang sinh học

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh điện ảnh chi tiết về người phụ nữ mặc áo choàng tối màu đang quỳ trong một nhà kính um tùm đầy ánh sáng phát quang sinh học.

#### 📝 Prompt

```
Cảnh quay điện ảnh góc rộng về một người phụ nữ trẻ đơn độc với mái tóc đen dài đang quỳ ở trung tâm của một mái vòm nhà kính rộng lớn um tùm. Áo choàng tối màu. Nhắm mắt. Những bông hoa màu tím phát quang sinh học và những dây leo rực rỡ bao quanh cô. Ánh sáng màu xanh mòng két mờ ảo xuyên qua mái kính. Mặt đất phủ đầy rêu. Yên tĩnh. Huyền bí. Siêu chi tiết. 8k.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094252201011216384/img/zaL6CQwmyOrz4LDY.jpg" width="600" alt="Người phụ nữ huyền bí trong nhà kính phát quang sinh học">
...
> Một câu lệnh kỹ thuật có cấu trúc cao dành cho cảnh không gian vũ trụ với các dải năng lượng xoáy và chuyển động ở mức trung bình

#### 📝 Prompt

```
{"shot": {"motion_level": "trung bình", "camera_depth": "cảnh trung", "camera_view": "ngang tầm mắt", "camera_movement": "cảnh tĩnh"}, "scene": {"location": "không gian vũ trụ trừu tượng", "environment": "Nền vũ trụ tối với các dải năng lượng xoáy"}}
```
...
> Một video prompt chủ đề thiên nhiên mô tả cảnh chim ruồi chăm sóc con non và bay lượn qua khu vườn bên cạnh.

#### 📝 Prompt

```
MỘT CHÚ CHIM RUỒI CHĂM SÓC CON NON VÀ BAY ĐẾN NHỮNG BÔNG HOA TRONG KHU VƯỜN BÊN CẠNH
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094539044755759104/img/Ikna7Jd9L-eADEmB.jpg" width="600" alt="Chuyến bay trong vườn của chim ruồi">
...
---
### Báo tuyết và Nữ chiến binh mặc giáp

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh tạo video giả tưởng phức tạp với hình ảnh một con báo tuyết khổng lồ và một người phụ nữ mặc giáp trắng đang cầm một lá cờ mang tính biểu tượng.

#### 📝 Prompt

```
Một con báo tuyết khổng lồ đang chạy xuyên qua khu rừng cùng một người phụ nữ có mái tóc trắng như băng và các biểu tượng trên vai, cô ấy mặc bộ giáp trắng và cầm một lá cờ có in con số 144.000 bằng vàng.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094511489340100608/img/X-0mfJzOFF-ZGFPE.jpg" width="600" alt="Báo tuyết và Nữ chiến binh mặc giáp">
...
---
### Đám mây tích chân thực

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh chi tiết để tạo hình ảnh đám mây trắng chân thực, yên bình trên nền trời xanh.

#### 📝 Prompt

```
Một đám mây tích trắng, xốp tuyệt đẹp trôi trên bầu trời xanh trong vắt, ánh sáng khối mềm mại, chân thực, độ chi tiết cao, không gian yên bình
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094468607145099264/img/kscj1_03PVJp2Km-.jpg" width="600" alt="Đám mây tích chân thực">
...
> Một câu lệnh chi tiết, chân thực về thác nước đổ xuống cùng với sương mù và chuyển động của tán lá.

#### 📝 Prompt

```
Thác nước đổ xuống mạnh mẽ và liên tục từ những vách đá gồ ghề vào hồ nước màu ngọc lam bên dưới, với làn sương mỏng cuộn xoáy và bốc lên trong ánh nắng, chuyển động tinh tế của tán lá xung quanh và những gợn sóng nước, chuyển động điện ảnh mượt mà, chân thực, độ chi tiết cao
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094444318379352064/img/EQyW9-Gr4eBcEBL0.jpg" width="600" alt="Thác nước hùng vĩ">
...
---
### Khám phá mẩu giấy tại tiệm trà Matcha

![English](https://img.shields.io/badge/lang-English-blue)

> Một đoạn prompt video điện ảnh chi tiết để tạo hoạt ảnh cho cảnh quay tại một tiệm trà Nhật Bản, nơi một mẩu giấy được tìm thấy.

#### 📝 Prompt

```
Hãy chuyển đổi hình ảnh này thành một video điện ảnh chân thực dài 15 giây. Giữ nguyên khuôn mặt, kiểu tóc, trang phục, trang sức, tỷ lệ cơ thể của người phụ nữ, nội thất quán cà phê, các chi tiết tiệm trà Nhật Bản, ánh sáng và bố cục.

0–4 giây: Cô ấy bình tĩnh hoàn thành việc pha trà matcha, nhẹ nhàng đẩy bát gốm về phía trước trên quầy gỗ. Các cử động của cô ấy cẩn thận và tự nhiên. Có sự chuyển động tinh tế của hơi thở, chớp mắt, mái tóc và chất liệu vải chân thực.

4–7 giây: Khi di chuyển bát trà, cô ấy nhận thấy một mẩu giấy viết tay nhỏ được gấp lại bên dưới. Cô ấy dừng lại, nhìn xuống với vẻ tò mò và cẩn thận nhặt mẩu giấy lên.

7–10 giây: Cô ấy mở mẩu giấy ra và đọc. Biểu cảm trên khuôn mặt cô từ từ thay đổi từ trung tính sang ngạc nhiên. Cô đọc lại một lần nữa, rõ ràng là rất bối rối trước nội dung trên giấy.

10–13 giây: Cô ấy nhìn quanh tiệm trà yên tĩnh, quan sát căn phòng như thể đang cố gắng tìm xem ai đã để lại mẩu giấy. Cô ấy nhìn thoáng qua về phía lối vào.

13–15 giây: Cô ấy nhìn lại mẩu giấy và khẽ thì thầm: “Cho mình sao?”. Sau đó, cô ấy nở một nụ cười nhỏ đầy vẻ không chắc chắn khi video kết thúc.

Diễn xuất tự nhiên chân thực, biểu cảm khuôn mặt tinh tế, cử động tay khéo léo, tương tác với giấy chân thực, ngón tay chính xác, vật lý tóc tự nhiên, bầu không khí quán cà phê Nhật Bản ấm áp, ánh sáng điện ảnh dịu nhẹ, độ sâu trường ảnh nông, chuyển động camera cầm tay nhẹ nhàng. Không có chuyển động cường điệu, không có chuyển động camera đột ngột, không có người lạ, không thay đổi khuôn mặt, không thay đổi trang phục, không biến dạng vật thể, không làm biến dạng bàn tay.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094383888613445632/img/u9pGKfdgULnvmdVD.jpg" width="600" alt="Khám phá mẩu giấy tại tiệm trà Matcha">
...
---
### Video toàn cảnh đại dương yên bình

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh video nhẹ nhàng cho cảnh quay toàn cảnh điện ảnh chậm rãi trên đại dương với sự xuất hiện của một con búp bê.

#### 📝 Prompt

```
con búp bê giữ nguyên vị trí và ngồi yên đó, cảnh quay toàn cảnh điện ảnh rất chậm, chuyển động không khí nhẹ nhàng, tâm trạng thanh bình và yên ả, chuyển động thanh lịch và tinh tế, không có chuyển động mạnh, tạo hiệu ứng chuyển động cho đại dương tự nhiên
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094382224653066240/img/mCnWdVTTbnN7WRbR.jpg" width="600" alt="Video toàn cảnh đại dương yên bình">
...
---
### Cảnh hành lang máy chủ phong cách anime

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh tạo ảnh anime neon có độ tương phản cao, mô tả một người phụ nữ trong hành lang máy chủ tối với các yếu tố hình ảnh ba chiều.

#### 📝 Prompt

```
Cảnh quay anime điện ảnh về một cô gái trẻ với mái tóc ngắn màu pastel óng ánh trong hành lang máy chủ tối. Mặc bộ đồ công nghệ màu đen với các đường mạch điện màu đỏ. Một bàn tay hình ảnh ba chiều dạng khung dây màu lục lam rực sáng đang vươn về phía máy ảnh. Đôi mắt nhắm nghiền. Những mảnh kính trôi nổi. Các giá đỡ máy chủ cao chót vót với vô số ánh đèn nhỏ. Các hạt kỹ thuật số. Neon độ tương phản cao. Siêu chi tiết. 8k.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094251548927025152/img/Z3S24lRd8qDuxm-K.jpg" width="600" alt="Cảnh hành lang máy chủ phong cách anime">
...
---
### Cảnh giải cứu thu nhỏ đậm chất điện ảnh

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh video điện ảnh về nhiệm vụ giải cứu trong thế giới thu nhỏ với bối cảnh chi tiết và chuyển động chân thực.

#### 📝 Prompt

```
Cảnh giải cứu thu nhỏ đậm chất điện ảnh trong một thế giới tí hon chân thực, một vài công nhân tí hon đang khẩn trương giải cứu một người/động vật nhỏ khỏi tình huống khó khăn, bối cảnh thủ công chi tiết, chuyển động chân thực, bầu không khí giàu cảm xúc nhưng đầy tính nhân văn, kịch tính...
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094299291691126784/img/a7Xs3JN4w6I2maWd.jpg" width="600" alt="Cảnh giải cứu thu nhỏ đậm chất điện ảnh">
...
---
### Hoạt ảnh kịch tính tại quán cà phê theo phong cách điện ảnh

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh tạo video nâng cao được thiết kế để chuyển đổi hình ảnh tĩnh thành một đoạn phim kịch tính dài 15 giây với thời gian và hành động của nhân vật chính xác.

#### 📝 Prompt

```
Tạo một video điện ảnh chân thực dài 15 giây từ hình ảnh này. Giữ nguyên khuôn mặt, danh tính, kiểu tóc, trang phục, trang sức, tỷ lệ cơ thể, nội thất quán cà phê, các vật dụng trên bàn, ánh sáng và bố cục của người phụ nữ. Hãy làm cho hoạt ảnh mang lại cảm giác như một khoảnh khắc đời thường thay vì một video thời trang. 0–3 giây: Cô ấy ngồi lặng lẽ tại bàn cà phê, thư giãn và hơi trầm tư. Các ngón tay cô đặt gần khuôn mặt. Cô chớp mắt tự nhiên, hơi thở nhẹ nhàng và mái tóc dài khẽ lay động. Ánh đèn quán cà phê ấm áp và ngọn lửa nến lung linh tự nhiên ở hậu cảnh. 3–6 giây: Điện thoại trên bàn đột ngột rung lên vì có thông báo. Cô nghe thấy, nhìn xuống, với lấy điện thoại và cầm lên. 6–9 giây: Cô mở khóa điện thoại và đọc tin nhắn. Biểu cảm của cô dần thay đổi từ thư giãn sang ngạc nhiên. Cô dừng lại một chút, đọc lại tin nhắn và đôi mắt hơi mở to. 9–12 giây: Cô hạ điện thoại xuống một chút và nhìn về phía cửa quán cà phê, bối rối và hơi lo lắng, như thể cô đột nhiên nhận ra có ai đó ở gần. 12–15 giây: Cô nhìn lại điện thoại một lần nữa. Tin nhắn trên màn hình hiển thị: “Anh đang ở ngoài. Đừng nhìn lại phía sau.” Biểu cảm của cô trở nên căng thẳng. Cô chậm rãi nhìn về phía cửa sổ thay vì quay người lại. Kết thúc ở khoảnh khắc đầy kịch tính này. Diễn xuất chân thực tự nhiên, biểu cảm khuôn mặt tinh tế, chớp mắt thực tế, chuyển động tay và ngón tay chính xác, tương tác với điện thoại đáng tin, vật lý tóc tự nhiên, chuyển động vải chân thực, không gian quán cà phê ấm áp tinh tế, độ sâu trường ảnh nông, chuyển động máy quay cầm tay rất nhẹ nhàng. Xây dựng sự kịch tính dần dần. Không có phản ứng thái quá, không có chuyển động máy quay đột ngột, không thấy người gửi, không có nhân vật phụ, không cắt cảnh, không thay đổi khuôn mặt, không thay đổi trang phục, không làm biến dạng tay hoặc điện thoại.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094274016601313280/img/tDJlh3HquBBgCAQp.jpg" width="600" alt="Hoạt ảnh kịch tính tại quán cà phê theo phong cách điện ảnh">
...
---
### Bay trở lại Starbase Texas

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh tập trung vào chuyển động, hướng dẫn các đối tượng bay lên khỏi mặt nước và di chuyển về một địa điểm cụ thể tại Texas.

#### 📝 Prompt

```
Yêu cầu cả hai bay lên khỏi mặt nước và bắt đầu bay trở lại Starbase, Texas
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094268532582219776/img/qp1kB85ccqNPZjsU.jpg" width="600" alt="Bay trở lại Starbase Texas">
...
---
### Minh họa Di tích Sa mạc Khổng lồ

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh video điện ảnh về chiếc mũ bảo hiểm cơ khí khổng lồ bị chôn vùi trên sa mạc cùng một vị khách nhỏ bé, theo phong cách tiểu thuyết đồ họa.

#### 📝 Prompt

```
Minh họa điện ảnh góc rộng về một chiếc mũ bảo hiểm cơ khí màu trắng khổng lồ đã cũ kỹ, bị chôn vùi một nửa trên sa mạc rộng lớn, với các tấm kim loại tán đinh và vết rỉ sét, một nhân vật nhỏ bé đơn độc đứng bên trong tấm che mặt đang mở nhìn vào trong, cát nhạt chất đống quanh chân đế, những ngọn núi thấp phía xa dưới bầu trời xanh trong, phong cách tiểu thuyết đồ họa, nét vẽ sạch sẽ, quy mô tĩnh lặng, siêu chi tiết, 8k
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093880020808925184/img/5REPjuGQLeVh0-4m.jpg" width="600" alt="Minh họa Di tích Sa mạc Khổng lồ">
...
---
### Cận cảnh phi công đầy kịch tính theo phong cách điện ảnh

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh video mang tính điện ảnh, đầy kịch tính về một nữ phi công trong buồng lái bị hư hại với ánh sáng màu cam và phong cách tiểu thuyết đồ họa.

#### 📝 Prompt

```
Cận cảnh điện ảnh đầy kịch tính về một nữ phi công bên trong buồng lái cũ kỹ, đội mũ bay màu vàng bị nứt với tấm kính che mặt vỡ một bên mắt, mồ hôi và một vệt máu mỏng trên mặt, đôi mắt mở to tập trung, đôi môi hơi hé mở, các đồng hồ đo analog phát sáng màu cam ấm áp ở phía sau, phong cách minh họa tiểu thuyết đồ họa, nét vẽ đậm, ánh sáng ấn tượng, bầu không khí căng thẳng, siêu chi tiết, 8k
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093879898020720640/img/mJlp1gFAFlwfjTpe.jpg" width="600" alt="Cận cảnh phi công đầy kịch tính theo phong cách điện ảnh">
...
---
### Sự xuất hiện của Tesla Optimus Cyber Taxi

![English](https://img.shields.io/badge/lang-English-blue)

> Một kịch bản tương lai với robot Tesla Optimus bước xuống từ Cyber Taxi và gõ cửa nhà bạn.

#### 📝 Prompt

```
Robot Tesla Optimus hoàn toàn mới của bạn dừng chân trên chiếc Cyber Taxi 🚕 và gõ cửa nhà bạn…
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094218594431143936/img/t4L5eUa2nj5aPFhe.jpg" width="600" alt="Sự xuất hiện của Tesla Optimus Cyber Taxi">
...
---
### Video giới thiệu Tesla Optimus tại nhà máy

![English](https://img.shields.io/badge/lang-English-blue)

> Một gợi ý (prompt) cho phần hero trên trang đích mang phong cách điện ảnh, tương lai, mô tả robot Tesla Optimus đang bước đi trên sàn nhà máy tối mờ với lớp sương mù thể tích.

#### 📝 Prompt

```
Phần hero trên trang đích mô tả Tesla Optimus đang bước đi trên sàn nhà máy. Tông màu từ xám than đậm đến gần như đen. Hình ảnh khổ lớn đầy ấn tượng. Sự kết hợp giữa màu đồng và hổ phách ấm áp với màu xanh lục lam và xanh thép lạnh. Sương mù thể tích mềm mại. Độ tương phản điện ảnh. Giao diện người dùng (UI) bằng kính tinh tế. Phông chữ tinh xảo. Bố cục bất đối xứng. Khoảng trắng rộng rãi. Đẳng cấp vượt trội. Mang hơi hướng tương lai.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093898597893017600/img/9KGpmyCMtZAv63Wi.jpg" width="600" alt="Video giới thiệu Tesla Optimus tại nhà máy">
...
---
### Hoạt ảnh nhân vật bỏ mũ

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh video trong đó nhân vật bỏ mũ ra và nói một câu thoại đầy thách thức, gai góc.

#### 📝 Prompt

```
Tạo hoạt ảnh cho hình ảnh này cảnh nhân vật bỏ mũ ra và nói "nói đi đồ hèn, hay là ngươi thậm chí không có gan làm vậy, chắc là không rồi".
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094053656836403200/img/n5Qt2KA-KsY5IuVp.jpg" width="600" alt="Hoạt ảnh nhân vật bỏ mũ">
...
---
### Thay đổi trang phục 360 độ

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh video kỹ thuật để tạo hiệu ứng xoay 360 độ mượt mà, trong đó chủ thể thay đổi trang phục sau mỗi vòng quay của camera.

#### 📝 Prompt

```
Camera xoay 360 độ mượt mà với tốc độ nhanh, trong khi trang phục của người đàn ông thay đổi sau mỗi vòng quay, trước mỗi lần xoay người đàn ông búng tay để đổi sang bộ đồ mới, giữ nguyên cùng một người và tư thế ổn định tại chỗ, camera xoay 360 độ không ngừng nghỉ, thay đổi duy nhất là trang phục, hiệu ứng timelapse, chuyển động liền mạch
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094052255523639296/img/bpo_riyioik03HRS.jpg" width="600" alt="Thay đổi trang phục 360 độ">
...
---
### Quý tộc nữ thời Trung cổ trên tường thành

![English](https://img.shields.io/badge/lang-English-blue)

> Một video prompt theo phong cách tranh sơn dầu điện ảnh, mô tả một quý tộc nữ khoác áo choàng đen vàng đang nhìn ra thung lũng núi với những đám mây bão và tia nắng.

#### 📝 Prompt

```
Tranh sơn dầu giả tưởng thời Trung cổ cổ điển về một quý tộc nữ với mái tóc dài sẫm màu đang đứng trên tường thành bằng đá cao, nhìn từ phía sau và hơi nghiêng sang một bên, khoác trên mình chiếc áo choàng đen sang trọng với những đường thêu vàng tinh xảo bay trong gió, nhìn ra thung lũng núi bao la với dòng sông uốn lượn, những cánh rừng rậm rạp và một thành phố lâu đài ở phía xa, những đám mây bão kịch tính đang tan dần với những tia nắng vàng rực rỡ, nét cọ vẽ nghệ thuật, quy mô điện ảnh, bầu không khí sử thi, siêu chi tiết, 8k
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093879783499464704/img/wM21diJcLNvTZ5P-.jpg" width="600" alt="Quý tộc nữ thời Trung cổ trên tường thành">
...
---
### Hoạt ảnh đường phố với nhân vật khỉ nhất quán

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh chuyển đổi hình ảnh thành video tập trung vào việc duy trì sự nhất quán hoàn hảo của nhân vật khỉ và môi trường xung quanh.

#### 📝 Prompt

```
Bắt đầu từ hình ảnh chính xác này và giữ nguyên nhân vật khỉ, khuôn mặt, bộ lông, cơ thể, quần áo, băng ghế, bức tường, cửa sổ cửa hàng, vỉa hè, ánh sáng và góc máy trong suốt quá trình. Không thay đổi vóc dáng, loài, trang phục hoặc bối cảnh. Không làm biến dạng hình ảnh. Đường phố chân thực c...
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094028641747218432/img/3jqwa_JFV0Zfv8yh.jpg" width="600" alt="Hoạt ảnh đường phố với nhân vật khỉ nhất quán">
...
---
### Phim tài liệu về chú khỉ trong nhà thờ với phong cách chân thực

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh tạo video chân thực để tạo đoạn clip phong cách phim tài liệu chậm về một chú khỉ trong nhà thờ, duy trì các chi tiết hình ảnh nhất quán từ hình ảnh tham chiếu.

#### 📝 Prompt

```
Bắt đầu từ hình ảnh chính xác này và giữ nguyên chú khỉ, khuôn mặt, bộ lông, quần áo, cuốn Kinh Thánh, bức tường, nhà thờ, ánh sáng và góc máy trong suốt quá trình. Không thay đổi cơ thể, hình dáng khuôn mặt, loài, trang phục hoặc phông nền.
Đoạn clip tài liệu chân thực, tĩnh lặng và chậm rãi.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094001242640900096/img/mMprhCzIizL8ErtE.jpg" width="600" alt="Phim tài liệu về chú khỉ trong nhà thờ với phong cách chân thực">
...
---
### Gợi ý video về điệu nhảy vòng tròn của các nữ thần thần thoại

![日本語](https://img.shields.io/badge/lang-日本語-green)

> Một gợi ý video chi tiết mô tả chuỗi hình ảnh các nữ thần thần thoại: Diana đùa nghịch với các loài vật trong khu rừng sâu, Artemis hát dưới ánh trăng cùng cây đàn hạc, và Persephone than khóc các sứ giả trong khi hát bài ca về sự luân hồi. Bầu không khí điện ảnh huyền bí và trang nghiêm.

#### 📝 Prompt

```
Nữ thần Diana đùa nghịch với các loài vật trong khu rừng sâu. Cảnh quay chuyển sang Artemis, nữ thần của ánh trăng đêm, đang hát một bài ca và ru ngủ bằng tiếng đàn hạc; Persephone, nữ thần máu, đang than khóc các sứ giả; các nữ thần tiếp tục hát bài ca về sự luân hồi, video dài 15 phút hát bằng tiếng Ý kèm âm nhạc, huyền bí, trang nghiêm
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093970430604488704/img/dUneXzq8ksJk4Tyo.jpg" width="600" alt="Gợi ý video về điệu nhảy vòng tròn của các nữ thần thần thoại">
...
> Một video prompt đầy kịch tính ghi lại tiếng gầm và sự dữ dội của một vụ phóng tên lửa Falcon Heavy.

#### 📝 Prompt

```
Vụ phóng Falcon Heavy
Âm thanh của hy vọng nhân loại
“Động cơ gầm vang, trái tim đập loạn nhịp. Tên lửa rung chuyển bên rìa lực hút của Trái Đất — chỉ còn một hơi thở nữa là biến màn đêm thành ngọn lửa....
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093900201723375616/img/lWNzm4JEhuAX6sIf.jpg" width="600" alt="Phóng tên lửa Falcon Heavy">
...
---
### Vụ nổ vũ trụ trên TV trong căn phòng đổ nát

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh (prompt) điện ảnh chi tiết về một người phụ nữ trong căn phòng đổ nát đang xem vụ nổ vũ trụ trên chiếc tivi CRT

#### 📝 Prompt

```
Góc nghiêng điện ảnh của một cô gái trẻ đang ngồi trong căn phòng tối tàn tạ, búi tóc rối, mặc chiếc áo len đan dày màu nâu, chăm chú nhìn vào chiếc tivi CRT cũ kỹ. Màn hình tivi rực sáng với vụ nổ vũ trụ sống động gồm các dải năng lượng màu lục lam, vàng, tím và cam, một hình bóng nhỏ bé hiện rõ ở trung tâm vụ nổ. Những bức tường bong tróc vôi vữa, tủ gỗ bám bụi, cửa sổ vỡ, ánh sáng duy nhất phát ra từ chiếc tivi chiếu rọi lên khuôn mặt cô. Ảnh chân thực, bầu không khí tâm trạng, ánh sáng nhấp nháy nhẹ từ màn hình, các hạt bụi bay trong không trung, tỷ lệ 16:9.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093559444944883712/img/ImQJUypW1fqM0XPD.jpg" width="600" alt="Vụ nổ vũ trụ trên TV trong căn phòng đổ nát">
...
---
### Prompt video: Các nữ thần trong bộ ba tranh triptych với hiệu ứng chuyển cảnh camera

![日本語](https://img.shields.io/badge/lang-日本語-green)

> Một prompt tạo video với bố cục chia 3 phần hiển thị các nhân vật thần thoại Artemis, Diana và Proserpina, với chỉ dẫn cụ thể để camera quay cận cảnh vào từng phần trong quá trình chuyển cảnh.

#### 📝 Prompt

```
Artemis, vào ban đêm, đang chơi đàn hạc trong đền thờ mặt trăng; Diana, trong rừng sâu, bên cạnh sói và hươu, đang giữ cây cung của mình; Proserpina, ở thế giới ngầm, cầu nguyện cho sự bình yên của nhân loại, ngoại hình đặc trưng của mỗi người, màn hình chia làm ba phần, huyền bí, chuyển cảnh bằng cách quay cận cảnh vào từng nhân vật
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093849686881005569/img/tGkbjPi8yy6G8fE2.jpg" width="600" alt="Prompt video: Các nữ thần trong bộ ba tranh triptych với hiệu ứng chuyển cảnh camera">
...
---
### Sóng phát quang nở rộ

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh điện ảnh mô tả ánh sáng tím rực rỡ nở rộ dọc theo đỉnh sóng trước khi tan biến vào bóng tối

#### 📝 Prompt

```
Nó cứ thế lan tỏa, và ánh sáng tím bừng nở dọc theo đỉnh sóng như thể có ai đó vừa quẹt diêm dưới làn nước. Ánh sáng ấy giữ nguyên trong ba giây dài, rồi dần tan biến vào bóng tối.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093842536888401920/img/Q0ORcHCfoRSmQJuG.jpg" width="600" alt="Sóng phát quang nở rộ">
...
---
### Sóng biển phát quang sinh học

![English](https://img.shields.io/badge/lang-English-blue)

> Một gợi ý mô tả đầy sống động về những con sóng phát quang sinh học màu xanh lục, trông như những chú đom đóm dưới nước.

#### 📝 Prompt

```
Những con sóng phát quang sinh học — đúng rồi, chính là nơi này. Khi nước đủ ấm, mỗi khi sóng vỗ đều tỏa ra ánh sáng màu xanh lục, tựa như những chú đom đóm đang thở giữa đại dương.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093839190999904257/img/8X2oSPPclHPXQl83.jpg" width="600" alt="Sóng biển phát quang sinh học">
...
---
### Timelapse quỹ đạo 360 độ

![English](https://img.shields.io/badge/lang-English-blue)

> Một video prompt kỹ thuật với hiệu ứng nhòe chuyển động phơi sáng lâu và quỹ đạo camera 360 độ quanh chủ thể.

#### 📝 Prompt

```
Anh ấy đang đứng yên tại chỗ, mọi người xung quanh di chuyển với hiệu ứng phơi sáng lâu, timelapse và nhòe chuyển động, kết hợp với chuyển động camera cầm tay dolly tiến lại gần, camera xoay quanh cơ thể anh ấy một góc 360 độ
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093840475153125376/img/aojsCP-3YxTfkBEc.jpg" width="600" alt="Timelapse quỹ đạo 360 độ">
...
---
### Khám phá chiếc đàn piano cổ đầu đời của bé

![English](https://img.shields.io/badge/lang-English-blue)

> Một thước phim gia đình ấm áp ghi lại khoảnh khắc bé 2 tuổi khám phá chiếc đàn piano cổ với niềm vui thuần khiết và sự thích thú khi làm quen với âm nhạc.

#### 📝 Prompt

```
Trong một thước phim gia đình ấm áp, một bé trai vui vẻ đang khám phá âm nhạc bên chiếc đàn piano cổ. Cậu bé 2 tuổi đáng yêu với mái tóc xoăn sẫm màu, đôi mắt sáng và nụ cười rạng rỡ, mặc áo phông trắng và tã, đang ngồi trên chiếc ghế băng màu be. Bé nhẹ nhàng nhấn từng phím đàn...
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093817673129795584/img/Gmtw8EsMRvfmwr1D.jpg" width="600" alt="Khám phá chiếc đàn piano cổ đầu đời của bé">
...
---
### Gothic Anime Crystal Moon Cinematic

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh tạo video đậm chất điện ảnh về một cô gái anime phong cách gothic với mái tóc rực rỡ, xung quanh là những viên pha lê trôi nổi dưới ánh trăng xanh.

#### 📝 Prompt

```
Chân dung điện ảnh của một cô gái anime xinh đẹp với mái tóc dài thẳng, chuyển màu từ hồng sang tím sống động và tóc mái bằng, đôi mắt tím phát sáng, biểu cảm tự tin. Cô mặc trang phục gothic bằng da đen bóng với dây đai, vòng kim loại, xích và găng tay dài. Xung quanh cô là những mảnh pha lê tím sắc nhọn trôi nổi giữa bầu trời đêm giả tưởng tăm tối với mặt trăng xanh khổng lồ đang tỏa sáng. Ánh sáng tím và xanh đầy kịch tính, thẩm mỹ giả tưởng đen tối thời thượng, các viên pha lê trôi chậm rãi, tóc chuyển động nhẹ, tỷ lệ 16:9.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093558947961868288/img/rVVMgMrvO8Qb0S6w.jpg" width="600" alt="Gothic Anime Crystal Moon Cinematic">
...
---
### Video Chiến dịch Giải cứu Minions

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh (prompt) tạo video điện ảnh mô tả các nhân vật hoạt hình đang kêu cứu trước một kẻ thù khổng lồ.

#### 📝 Prompt

```
Các Minion đang kêu cứu và họ chuẩn bị giải cứu chúng khỏi tên khổng lồ độc ác
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093793227941806080/img/eQ1rn-MloK5yinPS.jpg" width="600" alt="Video Chiến dịch Giải cứu Minions">
...
---
### Xi lanh thép không gỉ khổng lồ

![English](https://img.shields.io/badge/lang-English-blue)

> Mô tả chi tiết về một chiếc xi lanh công nghiệp cỡ lớn được đặt trong bối cảnh không gian ngoài trời

#### 📝 Prompt

```
Một chiếc xi lanh thép không gỉ khổng lồ, rộng 9 mét và dài 69 mét, nằm trống trải trên nền đất màu cam ngay cạnh gò cỏ ở phía bên phải khung hình, trải dài khắp bãi đất trống với đường kính 30 foot tương đương với chiều cao của gò cỏ
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093787519196274688/img/5MJnFuThi5oYrsAB.jpg" width="600" alt="Xi lanh thép không gỉ khổng lồ">
...
---
### Hoạt ảnh tượng Nhân sư xoay

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh (prompt) chuyển đổi hình ảnh thành video để tạo hiệu ứng chuyển động xoay camera cho tượng Nhân sư

#### 📝 Prompt

```
Tạo một video từ hình ảnh tượng Nhân sư này, với hiệu ứng camera xoay từ trái sang phải và ngược lại
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093778597387345920/img/iNSdAIFXJoexgyUM.jpg" width="600" alt="Hoạt ảnh tượng Nhân sư xoay">
...
---
### Nữ thần tóc đỏ năng lượng vũ trụ

![English](https://img.shields.io/badge/lang-English-blue)

> Cận cảnh đậm chất điện ảnh một người phụ nữ có mái tóc đỏ cùng những họa tiết vũ trụ phát sáng đang trôi nổi trong môi trường không trọng lực.

#### 📝 Prompt

```
Cận cảnh đậm chất điện ảnh một người phụ nữ xinh đẹp với mái tóc đỏ rực rỡ, dài bồng bềnh đang trôi nổi trong môi trường không trọng lực, đầu ngả ra sau, đôi mắt nhắm nghiền đầy mê đắm. Những họa tiết vàng rực rỡ tinh xảo tựa như nghệ thuật kintsugi hoặc các đường vân nóng chảy bao phủ khuôn mặt, cổ và ngực cô. Cô được bao bọc trong những dải năng lượng óng ánh, trong suốt, trông như dải lụa lỏng với các sắc thái tím, xanh mòng két, vàng và cầu vồng. Nền không gian sâu thẳm đầy sao, các hạt vũ trụ đầy màu sắc và hiệu ứng bokeh mềm mại. Chân thực như ảnh chụp, thẩm mỹ nữ thần thanh tao, làn da sáng bóng, mái tóc và các dải năng lượng chuyển động chậm rãi và uyển chuyển, tỷ lệ 16:9.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093558641895124992/img/ovbP3RucFdUhRbBy.jpg" width="600" alt="Nữ thần tóc đỏ năng lượng vũ trụ">
...
---
### Chú cua nhảy breakdance trên nền nhạc trap

![English](https://img.shields.io/badge/lang-English-blue)

> Một video prompt đầy năng lượng về chú cua đang thực hiện các động tác breakdance đồng bộ với nhịp nhạc trap, kết hợp các góc quay và chuyển động linh hoạt.

#### 📝 Prompt

```
Chú cua đang nhảy breakdance và xoay tròn trên mai với nguồn năng lượng cao, các chân và càng vung vẩy nhịp nhàng theo giai điệu trap rap mạnh mẽ phong cách 2 Chainz, các động tác xoay liên tục và dừng hình ấn tượng, góc quay thấp đầy năng động, slo...
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093699054563643393/img/sLoYR9ib3MzFtTNv.jpg" width="600" alt="Chú cua nhảy breakdance trên nền nhạc trap">
...
---
### Video typography với hiệu ứng phô mai tan chảy trên bãi biển lúc hoàng hôn

![English](https://img.shields.io/badge/lang-English-blue)

> Một câu lệnh tạo video sáng tạo giúp tạo ra văn bản cách điệu với hiệu ứng chuyển màu hoàng hôn, lấy cảm hứng từ khung cảnh bãi biển lúc hoàng hôn và phô mai tan chảy trên bánh tortilla chips.

#### 📝 Prompt

```
Chỉnh sửa hiệu ứng chữ chuyển màu đỏ cam rực rỡ cho kiểu chữ này với nội dung hoàng hôn trên bãi biển, phô mai tan chảy trên bánh tortilla chips
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093613181478535168/img/9Hy7H3Wq1IaEwRTK.jpg" width="600" alt="Video typography với hiệu ứng phô mai tan chảy trên bãi biển lúc hoàng hôn">
...
---
### Kỷ lục đường đua của Valentino Rossi

![English](https://img.shields.io/badge/lang-English-blue)

> Một video prompt về đua xe với sự xuất hiện của Valentino Rossi trên chiếc Ducati Streetfighter R tại đường đua Nürburgring.

#### 📝 Prompt

```
VALENTINO ROSSI CẦM LÁI CHIẾC DUCATI STREETFIGHTER R ĐƯỢC ĐỘ MỚI VÀ PHÁ KỶ LỤC ĐƯỜNG ĐUA NÜRBURGRING - ROSSI LÀ HUYỀN THOẠI
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093492695650164736/img/_9dU6QiY4NYtRXsR.jpg" width="600" alt="Kỷ lục đường đua của Valentino Rossi">
...
<sub>🤖 This README is automatically generated. Last updated: 2026-09-07T20:07:20.969Z</sub>
