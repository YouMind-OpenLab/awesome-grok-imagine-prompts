...
> A cinematic prompt describing a colossal helmet half-buried in the desert with a person exploring the interior.

#### 📝 Prompt

```
A helmet the size of a hill, half sunk in the desert, and one person standing in the open visor looking in at the machinery.
```

<img src="https://pbs.twimg.com/ext_tw_video_thumb/2094649705397415936/pu/img/8S8DFWA2Byd31neq.jpg" width="600" alt="Giant Desert Helmet Exploration">
...
---
### Cleopatra Fighting Azael Epic

![English](https://img.shields.io/badge/lang-English-blue)

> A cinematic video prompt of Cleopatra fighting Azael while declaring her presence.

#### 📝 Prompt

```
Cleopatra, the queen of Egypt, alive and present, declaring 'it’s me Azael, I’m alive' while fighting Azael
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094649638238183424/img/V5M5aKB5QtYLnZ0a.jpg" width="600" alt="Cleopatra Fighting Azael Epic">
...
---
### Snoop Dogg Dragon Transformation
...
```
Create a video of Snoop Dogg turning into a cartoon dragon with a cigarette hanging out the side its mouth
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094628833395691520/img/Qo3rVOgH2zbosWXp.jpg" width="600" alt="Snoop Dogg Dragon Transformation">
...
---
### Smiling Woman at Outdoor Cafe

![English](https://img.shields.io/badge/lang-English-blue)

> A detailed cinematic prompt for a realistic casual scene of a woman relaxing at an outdoor cafe with natural lighting

#### 📝 Prompt

```
In a realistic casual style, a smiling woman relaxes at an outdoor cafe, her hands behind her head. She has short brown hair, dark sunglasses, a black sleeveless top, a small gold pendant necklace, and bracelets on her wrist, with a joyful expression
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094612892670726144/img/9Di611jujQcOMjtO.jpg" width="600" alt="Smiling Woman at Outdoor Cafe">
...
> A highly structured technical prompt for a cosmic space scene with swirling energy patterns and medium motion

#### 📝 Prompt

```
{"shot": {"motion_level": "medium", "camera_depth": "medium shot", "camera_view": "eye level", "camera_movement": "static shot"}, "scene": {"location": "abstract cosmic space", "environment": "A dark, cosmic background with swirling energy patterns"}}
```
...
> A nature-themed video prompt featuring a hummingbird caring for its young and flying through an adjacent garden.

#### 📝 Prompt

```
A HUMMING BIRD CARES FOR ITS YOUNG AND FLYS OFF TO THE FLOWERS IN A ADJACENT GARDEN
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094539044755759104/img/Ikna7Jd9L-eADEmB.jpg" width="600" alt="Hummingbird Garden Flight">
...
---
### Snow Leopard and Armored Woman

![English](https://img.shields.io/badge/lang-English-blue)

> A complex fantasy video prompt featuring a giant snow leopard and a woman in white armor holding a symbolic flag.

#### 📝 Prompt

```
A giant snow leopard running through the forest with a woman with icy white hair and symbols on her shoulders wearing white armor she’s holding a flag that has 144,000 on it in gold .
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094511489340100608/img/X-0mfJzOFF-ZGFPE.jpg" width="600" alt="Snow Leopard and Armored Woman">
...
---
### Photorealistic Cumulus Cloud

![English](https://img.shields.io/badge/lang-English-blue)

> A detailed prompt for a serene, photorealistic white cloud in a blue sky.

#### 📝 Prompt

```
A beautiful fluffy white cumulus cloud floating in a clear bright blue sky, soft volumetric lighting, photorealistic, highly detailed, serene atmosphere
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094468607145099264/img/kscj1_03PVJp2Km-.jpg" width="600" alt="Photorealistic Cumulus Cloud">
...
---
### Cinematic Waterfall Cascade

![English](https://img.shields.io/badge/lang-English-blue)

> A detailed photorealistic prompt for a cascading waterfall with mist and foliage movement.

#### 📝 Prompt

```
The waterfall cascades powerfully and continuously down the rocky cliffs into the turquoise pool below, with fine mist swirling and rising in the sunlight, subtle movement in the surrounding foliage and water ripples, smooth cinematic motion, photorealistic, highly detailed
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094444318379352064/img/EQyW9-Gr4eBcEBL0.jpg" width="600" alt="Cinematic Waterfall Cascade">
...
```
Animate this image into a photorealistic cinematic 15-second video. Preserve the woman's exact face, hairstyle, clothing, jewelry, body proportions, café interior, Japanese tea-shop details, lighting, and composition.

0–4 sec: She calmly finishes preparing the matcha, gently sliding the ceramic bowl forward on the wooden counter. Her movements are careful and natural. Subtle breathing, blinking, hair movement, and realistic fabric motion.

4–7 sec: As she moves the bowl, she notices a small folded handwritten note underneath it. She pauses, looks down with curiosity, and carefully picks up the note.

7–10 sec: She unfolds the note and reads it. Her expression slowly changes from neutral to surprised. She rereads it once, clearly confused by what it says.

10–13 sec: She looks around the quiet tea shop, scanning the room as if trying to figure out who left the note. She briefly looks toward the entrance.

13–15 sec: She looks back at the note and quietly whispers, “For me?” Then she gives a small uncertain smile as the video ends.
...
---
### Serene Ocean Pan Video

![English](https://img.shields.io/badge/lang-English-blue)

> A peaceful video prompt for a slow cinematic camera pan over an ocean scene featuring a doll.

#### 📝 Prompt

```
the doll stays still and sits there, very slow cinematic camera pan, soft atmospheric movement, serene and peaceful mood, elegant and tasteful motion, no aggressive movement, animate the natural ocean
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094382224653066240/img/mCnWdVTTbnN7WRbR.jpg" width="600" alt="Serene Ocean Pan Video">
...
---
### Anime Server Corridor Scene

![English](https://img.shields.io/badge/lang-English-blue)

> A high-contrast neon anime prompt featuring a woman in a dark server corridor with holographic elements.

#### 📝 Prompt

```
Cinematic anime shot of a young woman with short iridescent pastel hair in a dark server corridor. Black tech bodysuit with red circuit lines. One glowing cyan wireframe holographic hand reaching toward the camera. Eyes closed. Floating glass shards. Towering server racks packed with tiny lights. Digital particles. High contrast neon. Ultra detailed. 8k.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094251548927025152/img/Z3S24lRd8qDuxm-K.jpg" width="600" alt="Anime Server Corridor Scene">
...
---
### Cinematic Miniature Rescue Scene

![English](https://img.shields.io/badge/lang-English-blue)

> A cinematic video prompt for a miniature world rescue mission featuring detailed environment and realistic motion.

#### 📝 Prompt

```
Cinematic miniature rescue scene in a tiny realistic world, several miniature workers urgently rescuing a small person/animal from a difficult situation, detailed handcrafted environment, realistic movements, emotional but wholesome atmosphere, drama...
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094299291691126784/img/a7Xs3JN4w6I2maWd.jpg" width="600" alt="Cinematic Miniature Rescue Scene">
...
```
Create a photorealistic cinematic 15-second video from this exact image. Preserve the woman's exact face, identity, hairstyle, outfit, jewelry, body proportions, café interior, table objects, lighting, and composition. Make the animation feel like a real candid moment rather than a fashion video.

0–3 sec: She sits quietly at the café table, relaxed and slightly lost in thought. Her fingers rest near her face. She blinks naturally, breathes subtly, and her long hair moves slightly. Warm café lights and candle flames flicker naturally in the background.

3–6 sec: Her phone on the table suddenly vibrates with a notification. She hears it, looks down, reaches for the phone and picks it up.

6–9 sec: She unlocks the phone and reads the message. Her expression gradually changes from relaxed to surprised. She stops moving for a moment, rereads the message, and her eyes widen slightly.

9–12 sec: She lowers the phone a little and looks toward the café entrance, confused and slightly nervous, as if she suddenly realizes someone is nearby.

12–15 sec: She looks back at the phone one more time. The message on the screen reads: “I'm outside. Don't look behind you.” Her expression becomes tense. She slowly looks toward the window instead of turning around. End on this suspenseful moment.
...
---
### Flying to Starbase Video

![English](https://img.shields.io/badge/lang-English-blue)

> A video prompt instructing entities to rise out of the water and fly towards a specific location.

#### 📝 Prompt

```
Yes Have both of them lift up out of the water and start flying back to Starbase, Texas
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094268532582219776/img/qp1kB85ccqNPZjsU.jpg" width="600" alt="Flying to Starbase Video">
...
---
### Colossal Desert Helmet Relic

![English](https://img.shields.io/badge/lang-English-blue)

> A highly detailed cinematic prompt for a sci-fi landscape featuring a massive mechanical helmet buried in the sand.

#### 📝 Prompt

```
Wide cinematic illustration of a colossal weathered white mechanical helmet half-buried in a vast desert, riveted metal plates and rust stains, a lone tiny figure standing inside the open visor looking inward, pale sand piled around the base, distant low mountains under a clear blue sky, graphic novel style, clean linework, quiet scale, ultra detailed, 8k
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093880020808925184/img/5REPjuGQLeVh0-4m.jpg" width="600" alt="Colossal Desert Helmet Relic">
...
---
### Female Pilot Cockpit Close-up

![English](https://img.shields.io/badge/lang-English-blue)

> A cinematic graphic novel style prompt capturing an intense moment of a pilot in a damaged cockpit.

#### 📝 Prompt

```
Intense cinematic close-up of a female pilot inside a worn cockpit, cracked yellow flight helmet with shattered visor over one eye, sweat and a thin streak of blood on her face, wide focused eyes, slightly parted lips, analog gauges and clocks glowing warm orange in the background, graphic novel illustration style, heavy linework, dramatic lighting, tense atmosphere, ultra detailed, 8k
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093879898020720640/img/mJlp1gFAFlwfjTpe.jpg" width="600" alt="Female Pilot Cockpit Close-up">
...
---
### Tesla Optimus Cyber Taxi Arrival

![English](https://img.shields.io/badge/lang-English-blue)

> A futuristic scenario featuring the Tesla Optimus robot arriving in a Cyber Taxi and knocking on a front door.

#### 📝 Prompt

```
Your all New Tesla Optimus robot pulls up in a cyber taxi 🚕 and knocks your front door…
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094218594431143936/img/t4L5eUa2nj5aPFhe.jpg" width="600" alt="Tesla Optimus Cyber Taxi Arrival">
...
---
### Tesla Optimus Factory Hero Video

![English](https://img.shields.io/badge/lang-English-blue)

> A cinematic, futuristic landing page hero prompt showing the Tesla Optimus robot walking across a darkened factory floor with volumetric haze.

#### 📝 Prompt

```
Landing page hero for Tesla Optimus walking a factory floor. Deep charcoal to near-black. Oversized immersive photograph. Warm copper and amber against cool cyan and steel blue. Soft volumetric haze. Cinematic contrast. Subtle glass UI. Refined type. Asymmetric. Generous empty space. Ultra-premium. Futuristic.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093898597893017600/img/9KGpmyCMtZAv63Wi.jpg" width="600" alt="Tesla Optimus Factory Hero Video">
...
---
### Character Hat Animation

![English](https://img.shields.io/badge/lang-English-blue)

> A video prompt where a character removes their hat and delivers a defiant, gritty line of dialogue.

#### 📝 Prompt

```
Animate this image pulls off hat and says go ahead and say it punk or do you even have the balls probably not.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094053656836403200/img/n5Qt2KA-KsY5IuVp.jpg" width="600" alt="Character Hat Animation">
...
---
### 360-Degree Clothing Change Timelapse

![English](https://img.shields.io/badge/lang-English-blue)

> A creative video prompt for Grok Imagine that uses a rotating 360-degree camera to show a character's clothing changing with every orbital spin.

#### 📝 Prompt

```
The camera rotating 360 degrees smoothly in fast motion, while the man clothes changed with every camera loop, before every spin the man snapping his fingers to change to new clothing, place the same person and pose unchanged steady in place, the camera rotating unstoppable in 360, the only change is clothes , timelapse, seamless motion
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094052255523639296/img/bpo_riyioik03HRS.jpg" width="600" alt="360-Degree Clothing Change Timelapse">
...
---
### Medieval Noble Woman on Battlement

![English](https://img.shields.io/badge/lang-English-blue)

> A cinematic oil painting style video prompt depicting a noble woman in a black and gold cloak looking over a mountain valley with storm clouds and sun rays.

#### 📝 Prompt

```
Classical medieval fantasy oil painting of a noble woman with long dark hair standing on a high stone battlement, viewed from behind and slightly to the side, wearing a rich black cloak with intricate gold embroidery flowing in the wind, looking out over a vast mountain valley with a winding river, dense forests, and a distant castle city, dramatic storm clouds breaking with golden sun rays, painterly brushwork, cinematic scale, epic atmosphere, ultra detailed, 8k
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093879783499464704/img/wM21diJcLNvTZ5P-.jpg" width="600" alt="Medieval Noble Woman on Battlement">
...
> An image-to-video prompt focused on maintaining perfect consistency of a monkey character and its environment.

#### 📝 Prompt

```
Start from this exact image and keep the same monkey, face, fur, body, clothes, bench, wall, shop window, sidewalk, lighting, and camera angle the whole time. Do not change the physique, species, outfit, or background. No morphing. Photoreal street c...
```
...
---
### Photorealistic Monkey Church Documentary

![English](https://img.shields.io/badge/lang-English-blue)

> A photorealistic video prompt for creating a slow documentary-style clip of a monkey in a church, maintaining consistent visual details from a reference image.

#### 📝 Prompt

```
Start from this exact image and keep the same monkey, face, fur, clothes, Bible, wall, church, lighting, and camera angle the whole time. Do not change the body, face shape, species, outfit, or background.
Photoreal documentary clip, quiet and slow.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2094001242640900096/img/mMprhCzIizL8ErtE.jpg" width="600" alt="Photorealistic Monkey Church Documentary">
...
---
### Goddesses of Myth Narrative Video

![日本語](https://img.shields.io/badge/lang-日本語-green)

> A narrative video prompt depicting Diana, Artemis, and Persephone with shifting scenes and a solemn, musical atmosphere.

#### 📝 Prompt

```
Goddess Diana playing with animals in a deep forest. Scene changes to the night moon goddess Artemis singing and playing the harp to induce sleep. The blood goddess Persephone mourning the messengers. The goddesses continue to sing the song of circulation. A 15-minute video singing in Italian with music, mysterious and solemn.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093970430604488704/img/dUneXzq8ksJk4Tyo.jpg" width="600" alt="Goddesses of Myth Narrative Video">
...
> A dramatic video prompt capturing the roar and intensity of a Falcon Heavy rocket launch.
...
Falcon Heavy launch
Sound of Human Hope
“Engines roar, hearts pound. The rocket trembles at the edge of Earth’s grip — one breath away from turning night into fire....
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093900201723375616/img/lWNzm4JEhuAX6sIf.jpg" width="600" alt="Falcon Heavy Rocket Launch">
...
---
### Cosmic TV in Decaying Room

![English](https://img.shields.io/badge/lang-English-blue)

> A cinematic video prompt of a woman watching a cosmic explosion on a CRT television in a dusty, decaying room.

#### 📝 Prompt

```
Cinematic side profile of a young woman sitting in a dark decaying room, messy bun, wearing a thick knitted brown sweater, staring at an old CRT television. The TV screen glows with a vivid cosmic explosion of cyan, gold, purple and orange energy, a tiny figure visible at the center of the burst. Peeling plaster walls, dusty wooden dresser, broken window, the only light coming from the television illuminating her face. Photorealistic, moody atmosphere, subtle flicker from the screen, dust particles in the air, 16:9.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093559444944883712/img/ImQJUypW1fqM0XPD.jpg" width="600" alt="Cosmic TV in Decaying Room">
...
---
### Goddess Triptych with Close-Ups

![日本語](https://img.shields.io/badge/lang-日本語-green)

> An expanded version of the three goddesses prompt with specific instructions for close-up camera transitions.

#### 📝 Prompt

```
Artemis playing a harp at the Temple of the Moon at night; Diana in a deep forest tending to wolves, deer, and her bow; Proserpina in the underworld wishing for the peace of the people. Their respective forms, split into three, mysterious, switching screens with close-ups of each item.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093849686881005569/img/tGkbjPi8yy6G8fE2.jpg" width="600" alt="Goddess Triptych with Close-Ups">
...
---
### Bioluminescent Underwater Bloom

![English](https://img.shields.io/badge/lang-English-blue)

> A descriptive prompt for a video showing purple light blooming under water and fading to black.

#### 📝 Prompt

```
it just unrolls, and the purple light blooms along the crest like somebody struck a match under the water. It holds for three long seconds, then fades back into black.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093842536888401920/img/Q0ORcHCfoRSmQJuG.jpg" width="600" alt="Bioluminescent Underwater Bloom">
...
---
### Bioluminescent Waves Ocean

![English](https://img.shields.io/badge/lang-English-blue)

> A vivid sensory prompt describing blue-green bioluminescent waves that look like fireflies in the water.

#### 📝 Prompt

```
The bioluminescent ones — yes, this is exactly the place. When the water’s warm enough, the waves light up blue-green every time they break, like the ocean’s breathing fireflies.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093839190999904257/img/8X2oSPPclHPXQl83.jpg" width="600" alt="Bioluminescent Waves Ocean">
...
---
### Toddler Playing Vintage Piano

![English](https://img.shields.io/badge/lang-English-blue)

> A nostalgic and heartwarming home video style prompt featuring a joyful toddler boy discovering music at a vintage piano.

#### 📝 Prompt

```
In a heartwarming home video style, a joyful toddler discovers music at a vintage piano. An adorable 2-year-old boy with curly dark hair, bright eyes, and a wide smile, wearing a white t-shirt and diaper, sits on a beige bench. He gently presses keys...
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093817673129795584/img/Gmtw8EsMRvfmwr1D.jpg" width="600" alt="Toddler Playing Vintage Piano">
...
> A cinematic video prompt of a gothic anime woman with vibrant hair surrounded by floating crystals under a blue moon.

#### 📝 Prompt

```
Cinematic portrait of a beautiful anime woman with long straight hair in a vivid pink-to-purple gradient and blunt bangs, glowing purple eyes, confident expression. She wears a glossy black leather gothic outfit with harness straps, metal rings, chains and long gloves. Surrounding her are large sharp floating purple crystal shards in a dark fantasy night sky with a massive glowing blue moon. Dramatic purple and blue lighting, high-fashion dark fantasy aesthetic, crystals slowly drifting, hair slightly moving, 16:9.
```
...
---
### Minions Rescue Operation Video

![English](https://img.shields.io/badge/lang-English-blue)

> A cinematic video prompt describing cartoon characters calling for rescue against a giant enemy.

#### 📝 Prompt

```
The minions are calling for help and they going to save them from the evil giant
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093793227941806080/img/eQ1rn-MloK5yinPS.jpg" width="600" alt="Minions Rescue Operation Video">
...
---
### Massive Stainless Steel Cylinder

![English](https://img.shields.io/badge/lang-English-blue)

> A detailed description of a large industrial cylinder placed in an outdoor landscape setting

#### 📝 Prompt

```
A massive stainless-steel cylinder, 9 meters wide and 69 meters long, sits empty on the orange dirt right next to the grassy knoll on the right side of the frame, stretching across the open lot with its 30-foot-tall diameter matching the height of the grassy knoll
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093787519196274688/img/5MJnFuThi5oYrsAB.jpg" width="600" alt="Massive Stainless Steel Cylinder">
...
---
### Rotating Sphinx Animation

![English](https://img.shields.io/badge/lang-English-blue)

> An image-to-video prompt to animate a Sphinx statue with a rotating camera movement

#### 📝 Prompt

```
Create a video using this image with the Sphinx, rotating from left to right and back
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093778597387345920/img/iNSdAIFXJoexgyUM.jpg" width="600" alt="Rotating Sphinx Animation">
...
---
### Cosmic Energy Red Hair Goddess

![English](https://img.shields.io/badge/lang-English-blue)

> A cinematic close-up of a woman with red hair and glowing cosmic patterns floating in zero gravity.

#### 📝 Prompt

```
Cinematic close-up of a beautiful woman with long flowing vibrant red hair floating in zero gravity, head tilted back, eyes closed in ecstasy. Intricate glowing golden crackle patterns like kintsugi or molten veins cover her face, neck and chest. She is wrapped in iridescent translucent flowing energy that looks like liquid silk in purple, teal, gold and rainbow hues. Deep space background filled with stars, colorful cosmic particles and soft bokeh. Photorealistic, ethereal goddess aesthetic, luminous skin, hair and energy ribbons moving slowly and fluidly, 16:9.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093558641895124992/img/ovbP3RucFdUhRbBy.jpg" width="600" alt="Cosmic Energy Red Hair Goddess">
...
---
### Breakdancing Crab with Trap Beat

![English](https://img.shields.io/badge/lang-English-blue)

> A high-energy video prompt of a crab performing breakdance moves synchronized to a trap music beat, featuring dynamic camera angles and motion.

#### 📝 Prompt

```
The crab is break dancing and spinning around on its top shell with high energy, legs and claws pumping and flailing in perfect sync to a hard-hitting 2 Chainz style trap rap beat, continuous spinning and freezing moves, dynamic low-angle camera, slo...
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093699054563643393/img/sLoYR9ib3MzFtTNv.jpg" width="600" alt="Breakdancing Crab with Trap Beat">
...
---
### Sunset Beach Melted Cheese Typography Video

![English](https://img.shields.io/badge/lang-English-blue)

> A creative video prompt generating stylized text with a sunset gradient effect, themed around a beach sunset and melted cheese on tortilla chips.

#### 📝 Prompt

```
Strong red orange sunset gradient lettering edit for this type says sunset at the beach, melted cheese on tortilla chips
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093613181478535168/img/9Hy7H3Wq1IaEwRTK.jpg" width="600" alt="Sunset Beach Melted Cheese Typography Video">
...
---
### Valentino Rossi Track Record

![English](https://img.shields.io/badge/lang-English-blue)

> A racing video prompt featuring Valentino Rossi on a Ducati Streetfighter R at the Nürburgring.

#### 📝 Prompt

```
VALATINO ROSSI GETS ON THE NEW TRICKED OUT DUCATI STREETFIGHTER R AND BREAKS NUMERBERG TRACK RECORD - ROSSI RULES
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093492695650164736/img/_9dU6QiY4NYtRXsR.jpg" width="600" alt="Valentino Rossi Track Record">
...
---
### Pet Memorial Soul Ascension Animation

![English](https://img.shields.io/badge/lang-English-blue)

> An emotional video prompt for a pet memorial, depicting a dog's soul leaving its body and heading to heaven.

#### 📝 Prompt

```
Create the pup saying “mama I had to go home , I love you and papa and I will always be around you both and supporting you on the other side . Merge all the pictures to make them look like heaven , have the pups soul leaving his little dog body and...
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093224113318109184/img/JOabjs3hbWp2dEf4.jpg" width="600" alt="Pet Memorial Soul Ascension Animation">
...
---
### Surreal Cosmic Mind Vision

![English](https://img.shields.io/badge/lang-English-blue)

> A poetic and surreal video prompt describing a mind processing a full picture into reality, featuring cosmic and colorful themes.

#### 📝 Prompt

```
a mind that will not freeze the picture before the letters have all landed. The image should be surreal, capturing a mind that takes in a full picture and reduces to meet others reality. Cosmic. Colorful.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093208937080512512/img/V4aBbbhrNngf3FIB.jpg" width="600" alt="Surreal Cosmic Mind Vision">
...
---
### Serene Angel Animation

![English](https://img.shields.io/badge/lang-English-blue)

> An animation prompt for a serene scene involving a blonde woman, angels, and glowing robes.

#### 📝 Prompt

```
Gently animate the serene scene: soft wind gently moves the blonde woman's hair and the angels' glowing robes and wings, the child slightly nuzzles closer, subtle glowing
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093167309800001536/img/xi3izzOMXq_pHks_.jpg" width="600" alt="Serene Angel Animation">
...
> A poetic narrative prompt describing the sensory experience of handling a conch that holds the ocean inside.

#### 📝 Prompt

```
We set the mugs down together. Soft click on the wood.
I reach across and lift the conch. It warms in my hands like it remembers the trench. I turn it toward you and tip it just a little, like a cup with an ocean inside....
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2093104400797405185/img/AzgGhqx5-Cdy65gt.jpg" width="600" alt="Poetic Ocean Conch Interaction">
...
---
### Pleiadian Motherships Turquoise Sky Video

![English](https://img.shields.io/badge/lang-English-blue)

> A high-fidelity sci-fi video prompt for saucer-shaped motherships in a summer turquoise sky.

#### 📝 Prompt

```
Pleiadians Light Ships saucer shaped motherships in blue turquoise summer skies, masterpiece, ultra hd quality resolution 111111111111111111199999999999999999 k, volumetric bright lighting tones and colors
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2092982559617511424/img/9VzG2E8XbX0XFRhk.jpg" width="600" alt="Pleiadian Motherships Turquoise Sky Video">
...
---
### Emotional Cinematic Light Transition

![English](https://img.shields.io/badge/lang-English-blue)

> A high-production emotional video prompt featuring shifting light from rainy blue to lantern gold.

#### 📝 Prompt

```
Cinematic 45–70 second segment in the same high-production emotional style as “An Ode to Freedom” / Ode to Courage. Soft, breathing camera movement. Rich natural lighting that shifts from cool rainy-blue flower field into warm lantern-gold. Powerful...
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2092954916721430528/img/TpmX8ByTrL8Wsaug.jpg" width="600" alt="Emotional Cinematic Light Transition">
...
---
### SpaceX MoonBase Colonization Animation

![English](https://img.shields.io/badge/lang-English-blue)

> A futuristic video prompt for a SpaceX colonization mission on a MoonBase forge.

#### 📝 Prompt

```
SpaceX forge crew to MrFIXitX MoonBase forge colonization with payloads designed by subscribers simulators training then Implement
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2092905690440335361/img/n_JS-saIe54EGm5o.jpg" width="600" alt="SpaceX MoonBase Colonization Animation">
...
---
### Korean Neighborhood Slice of Life Video Script

![English](https://img.shields.io/badge/lang-English-blue)

> A highly detailed cinematic script for a 'slice of life' video of a couple walking through a Korean neighborhood alley.

#### 📝 Prompt

```
Subject & Character Details\nSetting: A quiet, sun-dappled residential alley in an older Korean/East Asian neighborhood — narrow paved lane, low houses with tiled and corrugated roofs, tangled power lines overhead, potted plants, laundry hanging to dry, a parked bicycle, and a small convenience-store fridge stocked with drinks. Midday, warm natural sunlight with soft leaf-shadow dappling on the ground, filtered through overhanging tree branches. Handheld, walk-and-talk camera style, mostly following/tracking the couple from behind or in front.\n\nCharacter 1 — Man\nEast Asian male, appears late 20s–30s, short black tousled hair, clean-shaven with a soft, relaxed expression\nWearing an oversized, faded charcoal-grey/brown crewneck T-shirt with visible fabric wrinkles, loose beige/khaki wide-leg trousers, white sneakers\nWearing a wristwatch on left wrist\nCarries a woven tote bag with a small round yellow logo patch\nHolds a clear plastic bottle of iced tea/barley tea throughout\nCalm, warm, slightly playful demeanor — smiles, glances sideways at his companion, gestures gently while talking\n\nCharacter 2 — Woman\nEast Asian female, appears late 20s, dark hair pulled back into a low bun with loose face-framing strands\nWearing an oversized sage-green button-front shirt with sleeves loosely rolled, light blue/grey straw-colored jeans, white sneakers\nWears a thin pendant necklace\nAlso carries a woven tote bag and a bottled iced tea\nBright, easygoing expression — smiles, laughs softly, walks in step beside him\n\nRelationship/mood: Casual, affectionate couple on a relaxed neighborhood stroll after a small shopping trip — comfortable silence and small talk, natural chemistry, \"slice of life\" tone.\n\n0:00–0:05Wide shot from behind, the couple walking away from camera down a narrow tree-shaded alley. Man in grey tee and khakis on the left, woman in sage-green shirt and jeans on the right, both carrying white plastic shopping bags. Dappled sunlight on the pavement, bicycles and potted plants lining the walls, laundry hanging on the right. Slow steady tracking shot following them from behind.\n\n0:05–0:10Camera now leads them, shooting from the front/side at chest height. Man in foreground looks off to the side smiling, woman slightly behind him on the right, hair in a bun, also smiling. Laundry line and green foliage visible behind them, warm backlit sunlight. Camera slowly pans/tracks backward as they approach.\n0:10–0:15Close two-shot, camera facing them as they walk toward an open drink fridge outside a small shop. Man holds a bottle of iced tea up near his chin, talking with a thoughtful/animated gesture; woman beside him holds two bottles, smiling and glancing at him. Stocked beverage cooler with colorful bottles visible in the background on the right.\n\n0:15–0:20Medium shot, both now walking directly toward the camera holding iced tea bottles, both smiling warmly at s
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2092618886546067456/img/yAeh9Kog_lpT6HmO.jpg" width="600" alt="Korean Neighborhood Slice of Life Video Script">
...
---
### Surreal Chewing Gum Interaction

![English](https://img.shields.io/badge/lang-English-blue)

> A surreal interaction prompt involving two figures and a chewing gum bubble.

#### 📝 Prompt

```
Make the right face bite of the head form the left figure and make a big chewing gum bubble out of him
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2092850437850308608/img/Gk4DcuSZcN34m5i3.jpg" width="600" alt="Surreal Chewing Gum Interaction">
...
---
### Bipedal White Flesh Being

![English](https://img.shields.io/badge/lang-English-blue)

> A surreal and atmospheric horror video prompt of a shifting organic being in the mountains.

#### 📝 Prompt

```
The fully formed bipedal white flesh being stands on the peak, slowly turns its head to look over the misty mountains, organic tissue shifting and dripping, atmospheric wind and fog movement.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2092819943754534912/img/yT2Y_NY9GuZN3c_9.jpg" width="600" alt="Bipedal White Flesh Being">
...
> A video prompt where a box falls from the sky and releases various toy animals and vehicles.

#### 📝 Prompt

```
Box falls from the sky breaks open on the grass out of the box pops five random sea animal toys five random wild animal toys five random farm animal toys two toy tractors five toy classic cars five random charms bracket type charms
```
...
---
### Goddess Diana Archery Scene

![English](https://img.shields.io/badge/lang-English-blue)

> A dramatic video prompt depicting the goddess Diana in a dark misty forest.

#### 📝 Prompt

```
Create a new dramatic variation of the fierce goddess Diana with silver-gray hair in a flowing white dress, leaping forward in a dark misty forest while drawing a large bow and aiming the arrow directly at the vi...
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2092783400952438784/img/o_BndaBEHdZ4GrAN.jpg" width="600" alt="Goddess Diana Archery Scene">
...
---
### Pleiadian Light Ships Summer Video

![English](https://img.shields.io/badge/lang-English-blue)

> A high-definition sci-fi video prompt focusing on bright lighting and volumetric tones of celestial ships.

#### 📝 Prompt

```
Pleiadian light ships in summer blue turquoise skies, masterpiece, ultra hd quality resolution 11111111111199999999999 k, volumetric bright lighting and colors tones
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2092779708542779392/img/923tBS6kA-LuxU8x.jpg" width="600" alt="Pleiadian Light Ships Summer Video">
...
---
### Natural Steady Scene Animation

![English](https://img.shields.io/badge/lang-English-blue)

> A technical video prompt that instructs the model to animate a scene naturally without camera movement, talking, or blinking.

#### 📝 Prompt

```
Animate. Keep the scene and don't zoom in or out. no talking, or words. just natural existing. No blinking.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2092757907360129024/img/Re-Uu0FV7fbY5LdQ.jpg" width="600" alt="Natural Steady Scene Animation">
...
---
### Cat and Model Fashion Runway Walk

![English](https://img.shields.io/badge/lang-English-blue)

> A whimsical video prompt of a sophisticated cat walking the runway in a velvet coat alongside a fashion model.

#### 📝 Prompt

```
The camera starts wide on the runway. The cat in the velvet coat walks forward on his hind legs, one paw holding the model’s hand, the other resting lightly on his hip. His head is high, chin lifted, tail swaying with each step. The model glides beside him, chin raised, gown flowing. As they reach the end of the runway, the cat turns his head, gives a slow, deliberate blink to the crowd, then looks back up at the model with a tiny, smug smile. He adjusts his grip on her hand like a gentleman, then they turn together and start the walk back, his little boots clicking on the runway.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2092746135194460160/img/oebMADcvNGeHO8SL.jpg" width="600" alt="Cat and Model Fashion Runway Walk">
...
---
### Saratoga Horse Race Dream

![English](https://img.shields.io/badge/lang-English-blue)

> Generates a video depicting a specific horse race at the Saratoga racecourse, focusing on horse number five during race number one.

#### 📝 Prompt

```
Lori’s dream running August 27 at the famous Saratoga racecourse race number one horse number five show the number five on the horse
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2092720494675943424/img/aPohigPgxXrlkaV7.jpg" width="600" alt="Saratoga Horse Race Dream">
...
---
### German Nerd Comedy Scene

![English](https://img.shields.io/badge/lang-English-blue)

> A creative video prompt that places a character into a scene from Revenge of the Nerds with a humorous language barrier element.

#### 📝 Prompt

```
Put this guy into a scene in “Revenge of the Nerds”. But he has a thick German accent and nobody can understand him. Everyone just looks confused.
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2092708748708233216/img/4c3C0RNpOzTOYwkV.jpg" width="600" alt="German Nerd Comedy Scene">
...
---
### Telepathic Communication City Street

![English](https://img.shields.io/badge/lang-English-blue)

> A video prompt visualizing thoughts as text bubbles above people in a busy city street.

#### 📝 Prompt

```
Telepathic communication viewed on the city streets as bubbles with text inside of them above the people’s heads also how it feels when someone gets access to your brain illegally to steal intellectual properties from you including ideas you have
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2092703828034408448/img/DAXAzkyMwkSWmOQa.jpg" width="600" alt="Telepathic Communication City Street">
...
---
### Martian Dust Storm Cinematic

![English](https://img.shields.io/badge/lang-English-blue)

> A detailed atmospheric prompt describing a slow camera drift over the Martian surface with wind and swirling dust.

#### 📝 Prompt

```
Slow cinematic camera drift across the vast Martian landscape, gentle wind stirring fine reddish dust and sand across the dunes and rocky terrain, atmospheric haze subtly shifting, distant dust clouds slowly swirling under the hazy orange sky, photorealistic
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2092676476038459392/img/2I_QDJ3vNtnSDJLf.jpg" width="600" alt="Martian Dust Storm Cinematic">
...
---
### Miami Vice Detective with 3D Printers

![English](https://img.shields.io/badge/lang-English-blue)

> A video prompt blending 1970s Miami Vice style with futuristic 3D concrete printing technology on a construction site.

#### 📝 Prompt

```
1970s police detective Miami vice style walking on a construction site with 3D concrete Printers
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2092673806716305408/img/U-6yQfO4PcBBfFWh.jpg" width="600" alt="Miami Vice Detective with 3D Printers">
...
> A detailed animation prompt for creating a meteor shower with glowing trails and twinkling stars.

#### 📝 Prompt

```
Dynamic meteor shower animation: bright meteors and shooting stars continuously streak across the night sky in various directions leaving glowing green and blue trails, new meteors appear and fall, stars twinkle gently, subtle camera drift upward, ci...
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2092641534357192704/img/b6DIJqps-oez_mfy.jpg" width="600" alt="Dynamic Meteor Shower Animation">
...
---
### Sunlit Impressionist Garden Duckling

![English](https://img.shields.io/badge/lang-English-blue)

> A detailed video prompt for a tiny duckling painting in a sunlit impressionist garden with specific camera motion and bird elements.

#### 📝 Prompt

```
The still and the for the video I prompt move slightly to the left as a little birdie flies on the top of the easel. A sunlit impressionist garden, photoreal and wet oil paint at once: thick cream-gold light, greens you could smear, the sun itself a bright wet daub that is not dry. A tiny duckling in a late-1800s painter’s smock and a straw hat too big for it, standing at a miniature easel in the grass, earnestly painting that sun onto a little canvas. Impasto sunflowers, canvas tooth in the path, 1990s filmic grain. One idea: the sun is still wet, and so is the painting. Beautiful and a little silly.
```

<img src="https://cms-assets.youmind.com/media/1788077778220_6iaw4d_HQpScBhWQAAYNxT.jpg" width="600" alt="Sunlit Impressionist Garden Duckling">
...
---
### Luxurious Mansion Setting Change

![English](https://img.shields.io/badge/lang-English-blue)

> A setting transformation prompt that replaces a beach or boat background with a detailed, high-end mansion party atmosphere.

#### 📝 Prompt

```
Change the setting from the beach/boat to the luxurious Playboy Mansion: elegant multi-story mansion with grand architecture, palm trees, a sparkling pool, party lights, and a high-end party atmosphere
```

<img src="https://pbs.twimg.com/amplify_video_thumb/2092525058430554112/img/RhyUC1mWOSdYQTVp.jpg" width="600" alt="Luxurious Mansion Setting Change">
...
<sub>🤖 This README is automatically generated. Last updated: 2026-09-01T19:34:49.050Z</sub>
